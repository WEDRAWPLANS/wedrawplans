...
export default function Ealing() {
  const localBusinessJson = {
    ...
    "@type": "LocalBusiness",
    name: "WEDRAWPLANS",
    url: "https://www.wedrawplans.co.uk/ealing",
    ...
    description:
      "Architectural drawing services in Ealing for extensions, loft conversions, refurbishments, outbuildings and building regulation plans."
  };
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Yes. We prepare drawings, complete forms, upload documents, submit to Ealing Council and respond to planning officer queries."
        }
      }
    ]
  };
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings Ealing | Extensions and Lofts | WEDRAWPLANS
        </title>
        <meta
          name="description"
        ...
        />
        <link rel="canonical" href="https://www.wedrawplans.co.uk/ealing" />
        <script
        ...
        <section className="relative bg-emerald-900 text-white">
          <div className="absolute inset-0 opacity-15 mix-blend-soft-light">
            <Image
              ...
              alt="Architectural drawings for Ealing extensions and lofts"
              fill
          ...
          <div className="relative mx-auto max-w-5xl px-6 py-16 space-y-8">
            ...
            <p className="max-w-3xl text-sm md:text-base text-emerald-50">
              Architectural drawing services in Ealing Broadway, West Ealing,
              Hanwell, Acton, Southall, Greenford and across Ealing. We prepare
              drawings for extensions, loft conversions, refurbishments and
              outbuildings, aligned with Ealing Council guidance and current Building
              Regulations.
            </p>
              ...
              <div className="space-y-3 text-sm">
                <div className="grid sm:grid-cols-2 gap-3">
                  <ul className="space-y-1 list-disc pl-4">
                    ...
                    <li>Support with larger plots and side land</li>
                  </ul>
                  <ul className="space-y-1 list-disc pl-4">
                    <li>Drawings tailored to Ealing policies</li>
                ...
                <p className="mt-2 text-xs text-emerald-100">
                  Typical Ealing projects include rear and wrap extensions to semis
                  and detached homes, loft conversions, and full refurbishments with
                  new layouts and openings to the garden.
                </p>
              </div>
        ...
        <section className="mx-auto max-w-5xl px-6 py-14 space-y-14">
          ...
          <div className="grid md:grid-cols-[1.7fr,1.3fr] gap-10 items-start">
            <div className="space-y-4">
              ...
              <p className="text-sm md:text-base text-slate-700">
                ...
                outbuildings across the London Borough of Ealing.
              </p>
              <p className="text-sm md:text-base text-slate-700">
                We work throughout Ealing Broadway, West Ealing, Hanwell, Acton,
                Southall, Greenford, Perivale and Northolt, with drawings designed for
                semis, detached houses and maisonettes.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-white shadow-md border border-slate-100 overflow-hidden">
              ...
              <div className="p-5 space-y-2">
                ...
                <p className="text-sm text-slate-700">
                  Detailed plans, elevations and sections that suit extended kitchens,
                  open plan living spaces and improved links to the garden that are
                  common in Ealing projects.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
              <h3 className="text-lg font-semibold">Ealing areas we cover</h3>
              <Image
            ...
            <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
              <h3 className="text-lg font-semibold">Popular projects in Ealing</h3>
          ...
          <div className="space-y-5">
            ...
            <p className="text-sm text-slate-700">
              Many Ealing houses benefit from generous plots and permitted development
              potential, but conservation areas and some character streets can be
              more sensitive. Flats and maisonettes always need planning permission.
              We confirm the correct route at the start so that expectations are clear.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 text-sm text-slate-700">
              <div>
                ...
                <ul className="list-disc pl-4 space-y-1">
                  ...
                  <li>Larger schemes via Prior Approval</li>
                  <li>Impact on neighbours and gardens assessed</li>
                  <li>We check similar consents on nearby roads</li>
                </ul>
              </div>
              <div>
          ...
          <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-6 space-y-3">
            ...
            <p className="text-sm text-emerald-900">
              Ealing includes wide residential streets and larger plots that can work
              well for extensions and loft conversions. We design schemes that respect
              local character while delivering more usable space, light and value.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 text-sm text-slate-700">
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  Can you help with large wrap extensions in Ealing?
                </h3>
                <p>
                  Yes. We regularly prepare drawings for wrap extensions and side
                  extensions to semis and detached homes, including planning and
                  building regulation stage.
                </p>
              </div>
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  How fast can you survey a property in Ealing?
                </h3>
                <p>
              ...
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  Do you manage the planning submission to Ealing Council?
                </h3>
                <p>
          ...
          <div className="rounded-2xl bg-slate-900 text-white p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h2 className="text-xl font-semibold">
                Ready to start your Ealing project
              </h2>
              <p className="text-sm text-slate-300">
                Send us your address and a short description of the extension, loft or
