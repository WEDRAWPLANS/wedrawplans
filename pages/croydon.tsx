...
export default function Croydon() {
  const localBusinessJson = {
    ...
    "@type": "LocalBusiness",
    name: "WEDRAWPLANS",
    url: "https://www.wedrawplans.co.uk/croydon",
    ...
    description:
      "Architectural drawing services in Croydon for extensions, loft conversions, refurbishments, outbuildings and building regulation plans."
  };
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Not always. Many rear extensions in Croydon can be carried out under permitted development. We confirm the correct route once we review your address and house type."
        }
      },
      {
        "@type": "Question",
        name: "Is Croydon strict with loft conversions and extensions?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Croydon follows national permitted development rules but can be more careful with large extensions, roof alterations and backland schemes, especially in areas with strong character."
        }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Yes. We prepare drawings, complete forms, upload documents, submit to Croydon Council and respond to planning officer queries."
        }
      }
    ]
  };
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings Croydon | Extensions, Lofts, Refurbishments | WEDRAWPLANS
        </title>
        <meta
          name="description"
          content="Architectural drawing services in Croydon for extensions, loft conversions, refurbishments, outbuildings and building regulation plans. Fast surveys, clear drawings and full planning support with Croydon Council."
        />
        <link rel="canonical" href="https://www.wedrawplans.co.uk/croydon" />
        <script
        ...
        <section className="relative bg-emerald-900 text-white">
          <div className="absolute inset-0 opacity-15 mix-blend-soft-light">
            <Image
              ...
              alt="Architectural drawings for Croydon extensions and lofts"
              fill
          ...
          <div className="relative mx-auto max-w-5xl px-6 py-16 space-y-8">
            ...
            <p className="max-w-3xl text-sm md:text-base text-emerald-50">
              Architectural drawing services in Croydon for house extensions, loft
              conversions, refurbishments, outbuildings and small new build homes. All
              drawings are prepared to Croydon Council guidance and current Building
              Regulations.
            </p>
              ...
              <div className="space-y-3 text-sm">
                <div className="grid sm:grid-cols-2 gap-3">
                  <ul className="space-y-1 list-disc pl-4">
                    ...
                    <li>Support with large extensions and lofts</li>
                  </ul>
                  <ul className="space-y-1 list-disc pl-4">
                    <li>Drawings tailored to Croydon policies</li>
                ...
                <p className="mt-2 text-xs text-emerald-100">
                  Typical Croydon projects include large rear and wrap extensions in
                  South Croydon, Purley and Coulsdon, loft conversions in Thornton Heath
                  and Norbury, and internal reconfiguration and refurbishments across
                  the borough.
                </p>
              </div>
        ...
        <section className="mx-auto max-w-5xl px-6 py-14 space-y-14">
          ...
          <div className="grid md:grid-cols-[1.7fr,1.3fr] gap-10 items-start">
            <div className="space-y-4">
              ...
              <p className="text-sm md:text-base text-slate-700">
                ...
                outbuildings across the London Borough of Croydon.
              </p>
              <p className="text-sm md:text-base text-slate-700">
                We work throughout Croydon, South Croydon, Purley, Coulsdon, Kenley,
                Sanderstead, Shirley, New Addington, Thornton Heath, Norbury and
                surrounding areas.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-white shadow-md border border-slate-100 overflow-hidden">
              <Image
                src="/images/drawings.jpg"
                alt="Example of architectural drawings for a Croydon project"
                width={800}
                height={500}
              ...
              <div className="p-5 space-y-2">
                <h3 className="text-lg font-semibold">
                  Clear drawings for larger suburban homes
                </h3>
                <p className="text-sm text-slate-700">
                  Detailed plans, elevations and sections coordinated with structural
                  design, tailored to the semis and detached houses that are common in
                  Croydon and its surrounding districts.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
              <h3 className="text-lg font-semibold">Croydon areas we cover</h3>
              <Image
                src="/images/croydon-area.jpg"
                alt="Croydon local high street and residential area"
                width={800}
                height={500}
                className="rounded-xl object-cover mb-3"
              />
              <p className="text-sm text-slate-700">
                Architectural drawings for the whole borough of Croydon, including:
              </p>
              <div className="grid grid-cols-2 gap-2 text-sm text-slate-700">
                ...
                <ul className="list-disc pl-4 space-y-1">
                  ...
                  <li>Hillside and sloping sites</li>
                </ul>
              </div>
            </div>

            <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
              <h3 className="text-lg font-semibold">Popular projects in Croydon</h3>
          ...
          <div className="space-y-5">
            ...
            <p className="text-sm text-slate-700">
              Many houses in Croydon benefit from permitted development rights, but
              conservation areas, hillsides and streets with strong character can make
            ...
            <div className="grid md:grid-cols-3 gap-8 text-sm text-slate-700">
              ...
              <div>
                ...
                <ul className="list-disc pl-4 space-y-1">
                  ...
                  <li>Roof terraces assessed carefully</li>
                </ul>
              </div>
              <div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="rounded-2xl bg-white shadow-sm p-6 border border-slate-100 space-y-4">
              <h3 className="text-lg font-semibold">Planning drawings for Croydon</h3>
          ...
          <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-6 space-y-3">
            ...
            <p className="text-sm text-emerald-900">
              Croydon contains many larger houses and sloping plots where massing,
              overlooking and access are carefully reviewed. We design schemes that
              fit local character and topography while adding usable floor area and
              value to your home.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 text-sm text-slate-700">
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  Can you help with large family extensions in Croydon?
                </h3>
                <p>
                  Yes. We regularly prepare drawings for large rear, side and wrap
                  extensions in Croydon aimed at family kitchens, open plan living and
                  improved connection to the garden.
                </p>
              </div>
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  How fast can you survey a property in Croydon?
                </h3>
                <p>
              ...
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  Do you manage the planning submission to Croydon Council?
                </h3>
                <p>
              ...
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  Can you coordinate structural calculations for Croydon projects?
                </h3>
                <p>
          ...
          <div className="rounded-2xl bg-slate-900 text-white p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h2 className="text-xl font-semibold">
                Ready to start your Croydon project
              </h2>
