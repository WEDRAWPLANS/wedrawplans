...
export default function HaveringAreaPage() {
  ...
  const localBusinessJson = useMemo(
    () => ({
      ...
      image: "https://www.wedrawplans.co.uk/images/havering-extension-planning-drawings.jpg",
      address: {
        "@type": "PostalAddress",
      ...
      description:
        "Architectural drawing services in Havering for extensions, loft conversions, planning applications, garage conversions, outbuildings, conversions and building regulation packs. Fixed fees, clear scope, initial survey within 48 hours and fast communication.",
  ...
  const faqJson = useMemo(
    () => ({
      ...
      mainEntity: [
        {
          "@type": "Question",
          name: "Do I need planning permission for a rear extension in Havering",
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "Not always. Many rear extensions in Havering can be permitted development depending on the house type, depth, height, location and whether any restrictions affect the property. We confirm the correct route after checking your address.",
          },
        },
        {
          "@type": "Question",
          name: "Are loft conversions usually approved in Havering",
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "Many loft conversions are acceptable in Havering where the design is proportionate and suits the roof form and street character. Corner plots, flats, sensitive streets and some constrained sites may require more careful design and sometimes full planning.",
          },
        },
        {
          "@type": "Question",
          name: "How long does Havering Council take to decide planning applications",
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "Householder planning applications are normally decided within around 8 weeks after validation. Lawful Development Certificates are often around 4 to 8 weeks depending on workload.",
          },
        },
        {
          "@type": "Question",
          name: "Do you manage the submission to Havering Council",
          acceptedAnswer: {
            "@type": "Answer",
            text:
        ...
        {
          "@type": "Question",
          name: "Can you prepare building regulation drawings for Havering projects",
          acceptedAnswer: {
            "@type": "Answer",
            text:
        ...
        {
          "@type": "Question",
          name: "How quickly can you carry out a measured survey in Havering",
          acceptedAnswer: {
            "@type": "Answer",
            text:
        ...
        {
          "@type": "Question",
          name: "What drawings are usually required for a Havering planning submission",
          acceptedAnswer: {
            "@type": "Answer",
            text:
        ...
        {
          "@type": "Question",
          name: "Do you cover Romford, Hornchurch and Upminster",
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "Yes. We cover the wider Havering borough including Romford, Hornchurch, Upminster, Rainham, Harold Wood, Elm Park, Emerson Park, Gidea Park and nearby areas.",
          },
        },
        {
          "@type": "Question",
          name: "Can you help with garage conversions and garden rooms in Havering",
          acceptedAnswer: {
            "@type": "Answer",
            text:
  ...
  return (
    <>
      <Head>
        <title>Architectural Drawings in Havering | Planning and Building Regs Plans</title>
        <meta
          name="description"
          content="Architectural drawings in Havering for extensions, loft conversions, planning applications and building regulation packs. Fixed fees, clear scope, initial survey within 48 hours and fast communication."
        />
        <meta
          name="keywords"
          content="architectural drawings Havering, extension drawings Havering, loft conversion drawings Havering, planning drawings Havering, building regulation drawings Havering, architectural plans Romford, Hornchurch, Upminster"
        />
      ...
      <div className="min-h-screen bg-[#f8f4f0] text-slate-900">
        ...
        <main>
          <section className="border-b border-slate-200 bg-[#fdf8f3]">
            <div className="mx-auto max-w-6xl px-4 py-8 lg:px-6 lg:py-10">
              <div className="grid gap-8 lg:grid-cols-[1.06fr,0.94fr] lg:items-stretch">
                <div className="space-y-5">
                  <div>
                    ...
                    <h1 className="mt-2 text-[22px] font-semibold uppercase leading-snug tracking-[0.14em] text-slate-900 sm:text-[27px]">
                      Architectural Drawings in Havering for Extensions, Lofts and Building Regs
                    </h1>
                  ...
                  <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-md">
                    <Image
                      ...
                      alt="Architectural drawings for a Havering extension project"
                      width={1400}
                      height={950}
                      priority
                  ...
                  <p className="text-[13px] leading-7 text-slate-700">
                    ...
                    London Borough of Havering. We focus on approval ready submissions, practical layouts and
                  ...
                  <p className="text-[13px] leading-7 text-slate-700">
                    We work across Romford, Hornchurch, Upminster, Rainham, Gidea Park, Harold Wood, Elm Park,
                    Emerson Park, Collier Row and surrounding streets. If you are in RM1, RM2, RM3, RM5, RM7,
                    RM11, RM12, RM13 or RM14, we can advise quickly on the likely planning route and the drawings
                  ...
                  <div className="grid gap-3 sm:grid-cols-3">
                    ...
                    <TrustPill title="Havering aware" body="Prepared for real local planning routes." />
                  </div>
                  ...
                  <ul className="space-y-1 text-[13px] text-slate-800">
                    ...
                    <li>• Covering Romford, Hornchurch, Upminster, Rainham and surrounding areas</li>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                    <div className="text-[12px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                      Fast route for Havering homeowners
                    </div>
                ...
                <div id="havering-quote" className="space-y-6">
                  <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-md">
                    <div className="p-5">
                      <div className="text-[12px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                        Built for Havering homeowners
                      </div>
                      ...
                      <form onSubmit={handleSubmit} className="mt-4 space-y-3 text-[13px]">
                        ...
                        <div className="space-y-1">
                          <label className="text-[11px] font-medium text-slate-700">Havering postcode</label>
                          <input
                            name="postcode"
                            required
                            placeholder="RM11 1AA"
                            onFocus={(e) => {
                              e.target.placeholder = "";
                            }}
                            onBlur={(e) => {
                              if (!e.target.value) e.target.placeholder = "RM11 1AA";
                            }}
                        ...
                        <div className="space-y-1">
                          ...
                          <textarea
                            name="projectDetails"
                            rows={4}
                            placeholder="For example: rear extension to a semi detached house in Havering with a larger open plan kitchen diner and improved garden access."
                  ...
                  <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-md">
                    <Image
                      ...
                      alt="Completed extension and loft style interior visual for Havering homeowners"
                      width={1200}
                      height={900}
          ...
          <section className="border-b border-slate-200 bg-white py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              <h2 className="text-center text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Planning approved Havering project
              </h2>

              <p className="mx-auto mt-3 max-w-3xl text-center text-[13px] leading-7 text-slate-700">
                Havering planning approved project example showing how a full drawing package can move from concept stage
            ...
            <div className="mx-auto max-w-5xl space-y-10 px-4 lg:px-6">
              <div className="grid items-start gap-10 md:grid-cols-[1.25fr,0.95fr]">
                <div className="space-y-4">
                  <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                    Architectural drawing services in Havering
                  </h2>

                  <p className="text-[13px] leading-7 text-slate-700">
                    WEDRAWPLANS deliver planning drawings and technical packs for Havering homeowners and property
                  ...
                  <p className="text-[13px] leading-7 text-slate-700">
                    We work throughout Romford, Hornchurch, Upminster, Rainham, Elm Park, Gidea Park, Emerson Park,
                    Harold Wood, Harold Hill and nearby streets. If you are in RM1, RM2, RM3, RM5, RM7, RM11, RM12,
                    RM13 or RM14, we can advise quickly.
                  </p>
                  ...
                  <div className="grid gap-4 pt-2 sm:grid-cols-2">
                    ...
                    <div className="rounded-2xl border border-slate-100 bg-slate-50 p-5">
                      ...
                      <ul className="mt-3 list-disc space-y-1 pl-5 text-[13px] text-slate-700">
                        ...
                        <li>Havering specific planning route guidance</li>
                ...
                <div className="space-y-6">
                  <div className="overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-md">
                    <Image
                      src="/images/havering-drawings-layout.jpg"
                      alt="Architectural drawings laid out neatly for a Havering project"
                      width={800}
                      height={500}
                  ...
                  <div className="overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-md">
                    <Image
                      src="/images/havering-area-covered.jpg"
                      alt="Havering area coverage image showing local streets and housing"
                      width={800}
                      height={500}
                      className="h-56 w-full object-cover"
                    />
                    <div className="space-y-2 p-5">
                      ...
                      <p className="text-[13px] leading-7 text-slate-700">
                        We support homeowners across Havering with measured surveys, design development and
              ...
              <div className="grid gap-10 md:grid-cols-2">
                <div className="space-y-4 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                    Havering areas we cover
                  </h3>
                  <Image
                    src="/images/havering-area-covered.jpg"
                    alt="Havering streets and local housing across Romford Hornchurch Upminster Rainham and surrounding areas"
                    width={800}
                    height={500}
                    className="mb-3 rounded-xl object-cover"
                  />
                  <p className="text-[13px] text-slate-700">Drawings for the whole borough of Havering, including:</p>
                ...
                <div className="space-y-4 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                  ...
                  <Image
                    src="/images/havering-loft-conversion-interior.jpg"
                    alt="Completed extension and loft project in Havering style setting"
                    width={800}
                    height={500}
              ...
              <div className="space-y-5">
                ...
                <p className="text-[13px] text-slate-700">
                  Havering homeowners often want more than drawings. They want clarity on what changes are achievable,
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  ...
                  <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                    <Image
                      src="/images/havering-drawings-layout.jpg"
                      alt="Technical drawing set for a Havering project"
                      width={900}
                      height={700}
                      className="h-64 w-full object-cover"
                    />
              ...
              <div className="space-y-5">
                <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                  Permitted development limits in Havering
                </h2>
              ...
              <div className="grid gap-10 md:grid-cols-2">
                <div className="space-y-4 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                    Planning drawings for Havering
                  </h3>
                  <p className="text-[13px] leading-7 text-slate-700">
                    Our Havering planning drawings are set out for smooth validation and clear review. We make sure
                ...
                <div className="space-y-4 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                    Building regulation drawings for Havering
                  </h3>
                  <p className="text-[13px] leading-7 text-slate-700">
                    Our Havering building regs packs focus on buildability and compliance. They reduce site questions,
              ...
              <div className="space-y-3 rounded-2xl border border-emerald-100 bg-emerald-50 p-6">
                <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-emerald-900">
                  Local planning knowledge for Havering projects
                </h2>
                <p className="text-[13px] leading-7 text-emerald-900">
                  Havering includes established suburban housing, generous family plots, streets with strong residential
                  character and areas where proportion, roof form and neighbour impact still matter. We shape each
                  scheme to suit local character so approval confidence is as strong as possible while keeping the
                  layout practical for build cost, natural light and space gain.
                </p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-6 text-[13px] text-slate-700 md:grid-cols-2">
                  <div className="space-y-2 rounded-xl border border-slate-100 bg-white p-4">
                    <h3 className="font-semibold text-slate-900">Do I need planning permission in Havering</h3>
                    <p>
                  ...
                  <div className="space-y-2 rounded-xl border border-slate-100 bg-white p-4">
                    <h3 className="font-semibold text-slate-900">Do you submit to Havering Council</h3>
                  ...
                  <div className="space-y-2 rounded-xl border border-slate-100 bg-white p-4">
                    <h3 className="font-semibold text-slate-900">Do you cover Romford and Hornchurch</h3>
                    <p>
                      Yes. We cover Romford, Hornchurch, Upminster, Rainham, Harold Wood, Gidea Park and nearby
                  ...
                  <div className="space-y-2 rounded-xl border border-slate-100 bg-white p-4">
                    <h3 className="font-semibold text-slate-900">How do you help approval chances in Havering</h3>
                    <p>
          ...
          <section className="bg-[#f8f4f0] py-10">
            <div className="mx-auto max-w-5xl px-4 text-center lg:px-6">
              ...
              <p className="mt-3 text-[13px] text-slate-700">
                ...
                your Havering extension, loft conversion, refurbishment, garage conversion or small development project.
              </p>
          ...
          <SmartPlanningAssistant boroughName="Havering" />
        </main>
          ...
          <div className="mx-auto max-w-6xl px-4 py-10 lg:px-6">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-4 max-w-2xl text-[13px] leading-7 text-white/80">
                ...
                Building Regulations and small residential development projects across Havering, Romford, Hornchurch,
                Upminster, Rainham and surrounding areas.
              </p>
