...
const WHATSAPP_LINK =
  "https://wa.me/442036548508?text=Hello%20WEDRAWPLANS%2C%20I%20would%20like%20a%20quote%20for%20plans%20in%20Essex";

export default function EssexAreaPage() {
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    await submitBoroughLead(e, { boroughName: "Essex" });
  }

  function scrollToForm() {
    const el = document.getElementById("essex-quote");
  ...
  const localBusinessJson = {
    ...
    "@type": "LocalBusiness",
    name: "WEDRAWPLANS",
    url: "https://www.wedrawplans.co.uk/areas/essex",
    ...
    description:
      "Architectural drawing services in Essex for extensions, loft conversions, refurbishments, residential schemes and building regulation drawing packages.",
  };
  ...
  const faqJson = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "What drawings do I need for a house extension in Essex",
        acceptedAnswer: {
          "@type": "Answer",
          text:
      ...
      {
        "@type": "Question",
        name: "Do you work across all Essex towns",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Yes. We cover Essex widely, including Epping, Loughton, Buckhurst Hill, Chigwell, Brentwood, Chelmsford, Billericay, Rayleigh, Southend-on-Sea, Basildon, Harlow, Colchester and nearby areas.",
        },
      },
      {
        "@type": "Question",
  ...
  return (
    <>
      <Head>
        <title>Architectural Drawings in Essex | Extensions, Lofts, New Builds</title>
        <meta
          name="description"
          content="Architectural drawings in Essex for house extensions, loft conversions, refurbishments and building regulation packs. Fixed fees with clear scope and fast turnaround."
        />
        <link rel="canonical" href="https://www.wedrawplans.co.uk/areas/essex" />
        <script
      ...
      <div className="min-h-screen bg-[#f8f4f0] text-slate-900">
          ...
          <div className="mx-auto max-w-6xl px-4 pt-6 pb-3 lg:px-6">
            ...
            <div className="mt-2 flex w-full items-center justify-between gap-3">
              <div className="text-[12px] text-slate-700">
                <span className="font-semibold text-slate-900">Essex</span> area
                page
              </div>
        ...
        <main>
            ...
            <div className="mx-auto max-w-5xl flex flex-col lg:flex-row gap-6 px-4 py-8 lg:px-6 lg:py-10">
              <div className="lg:w-1/2">
                <p className="text-[11px] font-semibold uppercase tracking-[0.26em] text-red-700">
                  Essex architectural drawings
                </p>

                <h1 className="mt-2 text-[22px] sm:text-[26px] font-semibold uppercase leading-snug tracking-[0.14em]">
                  Plans for extensions, lofts and new builds in Essex
                </h1>
                ...
                <p className="mt-3 text-[13px] text-slate-700">
                  ...
                  residential projects across Essex and nearby areas. Fixed fees
                ...
                <ul className="mt-4 space-y-1 text-[13px] text-slate-800">
                  ...
                  <li>• Covering Epping Forest, Brentwood, Chelmsford, Basildon, Southend and more</li>
              ...
              <div id="essex-quote" className="lg:w-1/2">
                <div className="bg-white p-5 rounded-2xl shadow-md">
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onBlur={(e) =>
                          ...
                          (e.currentTarget.placeholder = "CM1 1AA")
                        }
                    ...
                    <p className="text-[11px] text-slate-500 mt-2">
                      Typical Essex projects include rear extensions, loft conversions,
                      refurbishments and internal remodelling.
                    </p>
                  </form>
                </div>
              </div>
          ...
          <ServiceInternalLinks boroughName="Essex" />
            ...
            <div className="mx-auto max-w-5xl px-4 lg:px-6 space-y-10">
              <div className="grid md:grid-cols-[1.7fr,1.3fr] gap-10 items-start">
                <div className="space-y-4">
                  <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em]">
                    Architectural drawing services in Essex
                  </h2>
                  <p className="text-[13px] text-slate-700">
                    ...
                    across Essex and nearby areas.
                  </p>
                  <p className="text-[13px] text-slate-700">
                    We regularly support projects around Epping Forest, Loughton, Buckhurst Hill,
                    Chigwell, Brentwood, Shenfield, Chelmsford, Billericay, Basildon, Rayleigh and
                    surrounding towns.
                  </p>
                ...
                <div className="rounded-2xl bg-white shadow-md border border-slate-100 overflow-hidden">
                  <Image
                    src="/images/Essex-project-1.jpg"
                    alt="Example of architectural drawings for an Essex project"
                    width={800}
                    height={500}
              ...
              <div className="grid md:grid-cols-2 gap-10">
                <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
                  ...
                  <Image
                    src="/images/Essex-area.jpg"
                    alt="Essex local area"
                    width={800}
                    height={500}
                    className="rounded-xl object-cover mb-3"
                  />
                  <p className="text-[13px] text-slate-700">
                    Drawings across Essex, including:
                  </p>
              ...
              <div className="space-y-5">
                <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em]">
                  Permitted development guidance in Essex
                </h2>
                <p className="text-[13px] text-slate-700">
              ...
              <div className="grid md:grid-cols-2 gap-10">
                ...
                <div className="rounded-2xl bg-white shadow-sm p-6 border border-slate-100 space-y-4">
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                    Building regulation drawings for Essex
                  </h3>
                  <ul className="list-disc pl-4 space-y-1 text-[13px] text-slate-700">
              ...
              <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-6 space-y-3">
                <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-emerald-900">
                  Local planning awareness for Essex projects
                </h2>
                <p className="text-[13px] text-emerald-900">
                  Many Essex areas include conservation zones, local design guides and street scene expectations, especially around period homes and prominent road frontages. We shape each scheme to fit context and produce a clear drawing package that supports a smooth decision.
                </p>
              </div>
