...
const HERO_IMAGE = "/images/ealing-hero.jpg";
const EALING_LOCAL_IMAGE = "/images/ealing-local.jpg";
const PROJECT_IMAGE_1 = "/images/ealing-project-1.jpg";
const PROJECT_IMAGE_2 = "/images/ealing-project-2.jpg";
...
function PlanningAssistant({
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: "assistant",
      text:
        "Hi, I am the WEDRAWPLANS planning assistant for Ealing. Tell me what you want to build and your postcode, and I will guide you to the fastest route for drawings and planning.",
    },
    {
      role: "assistant",
      text:
        "Quick start: type something like rear extension W5, loft conversion W3, wraparound extension UB1, or building regs pack W13.",
    },
  ]);
  ...
  const quickReplies = useMemo(
    () => [
      ...
      "How long does Ealing Council take",
      "Conservation area checks in Ealing",
  ...
  function extractPostcode(text: string) {
    ...
    const match = t.match(/\b(W|UB|NW)\d{1,2}\s?\d?[A-Z]{0,2}\b/g);
  ...
  function generateAssistantReply(userTextRaw: string) {
    ...
    if (hasSurveyIntent) {
      return [
        "We can usually arrange the initial measured survey within 48 hours in Ealing, subject to availability.",
    ...
    if (hasPlanningIntent) {
      return [
        "In Ealing, many house extensions and loft conversions can be permitted development, but it depends on house type, previous extensions, and conservation area constraints.",
    ...
    if (!knownPostcode || !knownType) {
      ...
      if (!knownPostcode) prompts.push("What is your postcode: for example W5, W13, W3, UB1");
      return [
    ...
    return [
      ...
      "Next step: request a fixed fee quote so we can confirm scope, survey timing, and the correct planning route for your address in Ealing.",
...
export default function EalingAreaPage() {
  ...
  const localBusinessJson = useMemo(
    () => ({
      ...
      description:
        "Architectural drawing services in Ealing for extensions, loft conversions, refurbishments and building regulation packs. Fixed fees with clear scope and fast communication.",
      priceRange: "££",
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "Ealing can be strict in conservation areas and on some streets with strong character. Clear drawings and a strong planning approach help.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "Householder planning applications normally take 6 to 8 weeks after validation. Lawful Development Certificates often take about 4 to 6 weeks, depending on workload and submission quality.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "Yes. We prepare drawings, complete forms, submit applications and respond to planning officer queries until a decision is issued.",
          },
        },
        {
          "@type": "Question",
          name: "How quickly can you survey a property in Ealing",
          acceptedAnswer: {
            "@type": "Answer",
            text:
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Architectural drawings in Ealing for house extensions, loft conversions, refurbishments and building regulation packs. Fixed fees with clear scope and fast communication."
        />
      ...
      <div className="min-h-screen bg-[#f8f4f0] text-slate-900">
        ...
        <main>
            ...
            <div className="mx-auto max-w-5xl flex flex-col lg:flex-row gap-6 px-4 py-8 lg:px-6 lg:py-10">
              <div className="lg:w-1/2">
                ...
                <h1 className="mt-2 text-[22px] sm:text-[26px] font-semibold uppercase leading-snug tracking-[0.14em]">
                  Plans for extensions, lofts and new builds in Ealing
                </h1>
                ...
                <p className="mt-3 text-[13px] text-slate-700">
                  WEDRAWPLANS prepare planning and technical drawings for house extensions, loft conversions, refurbishments and small residential schemes across Ealing.
                ...
                <ul className="mt-4 space-y-1 text-[13px] text-slate-800">
                  ...
                  <li>• Covering Ealing Broadway, Acton, Hanwell, Southall and more</li>
                ...
                <div className="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                  <div className="relative h-[190px] w-full">
                    <Image
                      src={EALING_LOCAL_IMAGE}
                      alt="Ealing local streets and home improvement area"
                      fill
                  ...
                  <div className="p-4">
                    ...
                    <p className="mt-2 text-[13px] text-slate-700">
                      We design schemes that suit Ealing streets, including conservation area constraints, with accurate measured surveys, clean layouts and clear drawings to help approvals run smoothly.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                  <div className="relative h-[190px] w-full">
                    <Image
                      src={HERO_IMAGE}
                      alt="Ealing planning support for extensions and lofts"
                      fill
                      sizes="(max-width: 1024px) 100vw, 520px"
                      className="object-cover"
                    />
                  ...
                  <form onSubmit={handleSubmit} className="mt-3 space-y-3 text-[13px]">
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        name="projectDetails"
                        rows={4}
                        placeholder="For example: rear extension to a terrace in Acton with new open plan kitchen."
                    ...
                    <p className="text-[11px] text-slate-500 mt-2">
                      Typical Ealing projects include rear extensions, wraparound extensions, loft conversions and refurbishments.
                    </p>
                  </form>
                </div>
              </div>
            ...
            <div className="mx-auto max-w-5xl px-4 lg:px-6 space-y-10">
              <div className="grid md:grid-cols-[1.7fr,1.3fr] gap-10 items-start">
                <div className="space-y-4">
                  ...
                  <p className="text-[13px] text-slate-700">
                    WEDRAWPLANS provide full drawing packages for single and double storey extensions, loft conversions, internal alterations, outbuildings, flat conversions and small new developments across Ealing.
                  </p>
                  <p className="text-[13px] text-slate-700">
              ...
              <div className="grid md:grid-cols-2 gap-10">
                <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
                  ...
                  <Image
                    src={PROJECT_IMAGE_1}
                    alt="Ealing area and typical home improvement projects"
                    width={800}
                    height={500}
                ...
                <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-[13px] text-slate-700">
                    ...
                    <ul className="list-disc pl-4 space-y-1">
                      ...
                      <li>Roof changes in character streets</li>
                  ...
                  <Image
                    src={PROJECT_IMAGE_2}
                    alt="Completed extension and loft example in Ealing"
                    width={800}
                    height={500}
              ...
              <div className="space-y-5">
                <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em]">
                  Permitted development limits in Ealing
                </h2>
                <p className="text-[13px] text-slate-700">
              ...
              <div className="grid md:grid-cols-2 gap-10">
                ...
                <div className="rounded-2xl bg-white shadow-sm p-6 border border-slate-100 space-y-4">
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                    Building regulation drawings for Ealing
                  </h3>
                  <ul className="list-disc pl-4 space-y-1 text-[13px] text-slate-700">
              ...
              <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-6 space-y-3">
                ...
                <p className="text-[13px] text-emerald-900">
                  Ealing includes conservation areas and varied street character, especially around Ealing Broadway, parts of Acton, and some quieter residential streets.
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-6 text-[13px] text-slate-700">
                  <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                    <h3 className="font-semibold text-slate-900">Do I need planning permission in Ealing</h3>
                    <p>
                  ...
                  <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                    <h3 className="font-semibold text-slate-900">Do you submit to Ealing Council</h3>
          ...
          <PlanningAssistant boroughName="Ealing" onGetQuote={scrollToForm} />
        </main>
      </div>
    </>
  );
