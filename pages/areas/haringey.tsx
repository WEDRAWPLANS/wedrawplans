...
export default function HaringeyAreaPage() {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Yes. We prepare drawings, complete forms, upload documents, submit to Haringey Council and respond to planning officer queries.",
        },
      },
    ],
  };
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings in Haringey | Extensions, Lofts, New Builds
        </title>
        <meta
          name="description"
          content="Architectural drawings in Haringey for house extensions, loft conversions, new builds and building regulation packs. Fixed fees with clear scope and fast turnaround."
        />
          ...
          <div className="mx-auto max-w-6xl px-4 pt-6 pb-3 lg:px-6">
            ...
            <div className="mt-2 flex w-full items-center justify-between gap-3">
              <div className="text-[12px] text-slate-700">
                <span className="font-semibold text-slate-900">Haringey</span>{" "}
                borough page
              </div>
            ...
            <div className="mx-auto max-w-5xl flex flex-col lg:flex-row gap-6 px-4 py-8 lg:px-6 lg:py-10">
              <div className="lg:w-1/2">
                ...
                <p className="mt-3 text-[13px] text-slate-700">
                  ...
                  extensions, loft conversions, new builds and conversions
                  across the London Borough of Haringey. Fixed fees with clear
                  scope and fast communication.
                </p>

                <ul className="mt-4 space-y-1 text-[13px] text-slate-800">
                  <li>
                    • House extensions, wrap around extensions and internal
                    remodelling
                  </li>
                  <li>
                    • Loft conversions including dormers and hip to gable options
                  </li>
                  <li>• New build houses and small residential schemes</li>
                  <li>• Planning drawings and building regulation packs</li>
                  <li>
                    • Covering Crouch End, Muswell Hill, Hornsey, Tottenham and
                    Wood Green
                  </li>
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        name="projectDetails"
                        rows={4}
                        placeholder="For example: rear and side extension to a Victorian terrace with open plan kitchen and a new loft room."
                    ...
                    <p className="text-[11px] text-slate-500 mt-2">
                      Typical Haringey projects include rear extensions, loft
                      conversions, flat conversions and internal remodelling.
                    </p>
                  </form>
                </div>
              </div>
            ...
            <div className="mx-auto max-w-5xl px-4 lg:px-6 space-y-10">
              <div className="grid md:grid-cols-[1.7fr,1.3fr] gap-10 items-start">
                <div className="space-y-4">
                  ...
                  <p className="text-[13px] text-slate-700">
                    WEDRAWPLANS provide full drawing packages for single and
                    double storey extensions, loft conversions, internal
                    alterations, outbuildings, flat conversions and small new
                    developments across the borough of Haringey.
                  </p>
                  <p className="text-[13px] text-slate-700">
                    We work throughout Crouch End, Muswell Hill, Harringay
                    Ladder, Green Lanes, Wood Green, Hornsey, Tottenham, Seven
                    Sisters, Bounds Green, Highgate borders and Finsbury Park.
                  </p>
              ...
              <div className="grid md:grid-cols-2 gap-10">
                <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                    Haringey areas we cover
                  </h3>
                  <Image
                    src="/images/haringey-area.jpg"
                    alt="Haringey local high street"
                    width={800}
                    height={500}
                    className="rounded-xl object-cover mb-3"
                  />
                  <p className="text-[13px] text-slate-700">
                    Drawings for the whole borough of Haringey, including:
                  </p>
              ...
              <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-6 space-y-3">
                ...
                <p className="text-[13px] text-emerald-900">
                  Haringey includes conservation areas in Crouch End, Muswell
                  Hill and Highgate borders, together with character streets and
                  dense terraces in Harringay Ladder and Tottenham. We shape
                  each scheme to fit local context so approval chances are as
                  strong as possible.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-6 text-[13px] text-slate-700">
                  ...
                  <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                    <h3 className="font-semibold text-slate-900">
                      Do you submit to Haringey Council
                    </h3>
                    <p>
