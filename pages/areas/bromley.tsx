  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#f8f4f0] text-slate-900">
       ...
       className="fixed bottom-4 right-4 z-[80] flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg ring-2 ring-white/70 hover:bg-[#1ebe57] sm:bottom-6"
        >
