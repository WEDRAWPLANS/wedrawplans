...
export default function HackneyAreaPage() {
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    alert(
      "Thank you. In the live site this form will email WEDRAWPLANS with your Hackney enquiry and trigger a same day call back."
    );
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings in Hackney – Extensions, Lofts and Conversions
        </title>
        <meta
          name="description"
          content="Architectural drawings in Hackney for house extensions, loft conversions, flat conversions, new builds and building regulation packs. Fixed fees from £750 with fast turnaround."
        />
      </Head>
      ...
      <div className="min-h-screen bg-[#f8f4f0] text-slate-900">
        ...
        <main>
            ...
            <div className="mx-auto flex max-w-5xl flex-col gap-6 px-4 py-8 lg:flex-row lg:items-start lg:px-6 lg:py-10">
              ...
              <div className="lg:w-1/2">
                ...
                <p className="mt-3 text-[13px] text-slate-700">
                  ...
                  and new builds across the London Borough of Hackney. Fixed fees with
                ...
                <ul className="mt-4 space-y-1 text-[13px] text-slate-800">
                  ...
                  <li>• Covering Hackney, Stoke Newington, Dalston, Clapton, Homerton and Hoxton side of Hackney</li>
              ...
              <div id="hackney-quote" className="lg:w-1/2">
                <div className="rounded-2xl bg-white p-5 shadow-md">
                  ...
                  <p className="mt-1 text-[12px] text-slate-600">
                    Tell us a little about your property in Hackney and what you plan
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium text-slate-700">
                        Brief description of your Hackney project
                      </label>
                      <textarea
                        name="projectDetails"
                        rows={4}
                        placeholder="For example: rear extension and loft conversion to a terrace in Stoke Newington with open plan kitchen at ground floor."
                    ...
                    <p className="mt-2 text-[11px] text-slate-500">
                      Typical Hackney projects include extensions, loft conversions and
                      flat conversions across Hackney Central, Stoke Newington, Dalston,
          ...
          <section className="border-b border-slate-200 bg-white py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Common project types in Hackney
              </h2>
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                Hackney includes Victorian terraces, post war estates and newer
                developments. Many homeowners extend, convert lofts or reconfigure
                layouts to create modern, flexible living spaces while staying in
                the area.
              </p>
              <div className="mt-5 grid gap-5 text-[13px] md:grid-cols-2">
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Single and double storey extensions to terraces are very common
                    in Hackney, Dalston and Clapton. We design open plan layouts,
                    structural openings and glazing that work with Hackney guidance.
                  </p>
                </div>
                <div>
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Rear dormer and L shaped lofts can add bedrooms and bathrooms
                    in many Hackney streets. We set out stairs, headroom and fire
                    protection to suit building control and London standards.
                  </p>
                </div>
                <div>
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Larger properties and corner plots can sometimes be converted
                    into self contained flats or small HMOs. We prepare layouts,
                    access diagrams and basic amenity information in line with
                    Hackney policy.
                  </p>
                </div>
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Side land, backland and small garage sites occasionally have
                    potential for new homes. WEDRAWPLANS produce planning drawings,
                    elevations and supporting material for submissions.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="border-b border-slate-200 bg-[#f8f4f0] py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              ...
              <ul className="mt-4 grid gap-2 text-[13px] text-slate-800 md:grid-cols-2">
                <li>• Hackney Central and London Fields</li>
                <li>• Stoke Newington and Newington Green</li>
                <li>• Dalston and De Beauvoir side of Hackney</li>
                <li>• Clapton (Upper and Lower)</li>
                <li>• Homerton and Hackney Wick</li>
                <li>• Hoxton and Haggerston side of Hackney</li>
              </ul>
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                Projects can be managed fully online with drawings issued by email,
                or combined with on site measured surveys where required.
              </p>
            </div>
          </section>
          ...
          <section className="border-b border-slate-200 bg-white py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Clear fixed fees for Hackney projects
              </h2>
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                Fees for Hackney projects follow the same clear structure as the
                rest of London, with adjustments for larger, more complex or
                multi unit schemes.
              </p>
          ...
          <section className="bg-[#f8f4f0] py-10">
            <div className="mx-auto max-w-5xl px-4 text-center lg:px-6">
              ...
              <p className="mt-3 text-[13px] text-slate-700">
                ...
                fee and suggested next steps for your Hackney extension, loft, flat
