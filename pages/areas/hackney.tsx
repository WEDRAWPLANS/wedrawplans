...
<meta name="description" content="Architectural drawing services in Hackney for extensions, loft conversions, flat conversions, outbuildings and building regulation plans. Initial survey within 48 hours, clear drawings and full planning support." />
        ...
        <div className="mx-auto max-w-5xl flex flex-col lg:flex-row gap-6 px-4 py-8 lg:px-6 lg:py-10">
          <div className="lg:w-1/2">
            ...
            <p className="mt-3 text-[13px] text-slate-700">
              ...
              including Dalston, Stoke Newington, Clapton, Homerton, Hoxton, Haggerston and Shoreditch.
            </p>

            <ul className="mt-4 space-y-1 text-[13px] text-slate-800">
              <li>• Initial survey within 48 hours</li>
              <li>• Permitted development, LDC and full planning support</li>
              <li>• Rear, side infill and wrap around extensions</li>
              ...
              <form onSubmit={handleSubmit} className="mt-3 space-y-3 text-[13px]">
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    name="projectDetails"
                    rows={4}
                    placeholder="Example: rear extension in Dalston with loft conversion above."
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="mt-2 text-[12px] text-slate-600">
                  Hackney streets, terraces and flat layouts supported with clear planning strategy.
                </p>
              </div>
            </div>
