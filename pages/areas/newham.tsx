...
export default function NewhamAreaPage() {
  ...
  const localBusinessJson = {
    ...
    description:
      "Architectural drawing services in Newham for extensions, loft conversions, HMOs, flat conversions, outbuildings, shop conversions and building regulation packs.",
  };
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Not always. Some rear extensions can be permitted development, but it depends on the property type, previous extensions, constraints and dimensions. We confirm the correct route once we review your address and house type.",
        },
      },
      {
        "@type": "Question",
        name: "Is Newham strict with loft conversions, HMOs and flat conversions?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Newham can be stricter with HMOs, flat conversions and larger extensions where parking, amenity space, daylight and overcrowding are affected. Clear drawings and a strong layout strategy help.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Householder planning applications usually take six to eight weeks after validation. Lawful Development Certificates often take four to six weeks, subject to validation and workload.",
        },
      },
      {
        "@type": "Question",
  ...
  return (
    <>
      <Head>
        <title>Architectural Drawings in Newham | Extensions, Lofts, HMOs, Conversions</title>
        <meta
          name="description"
          content="Architectural drawings in Newham for extensions, loft conversions, HMOs, flat conversions and building regulation packs. Fixed fees with clear scope and fast turnaround."
        />
      ...
      <div className="min-h-screen bg-[#f8f4f0] text-slate-900">
        <main>
            ...
            <div className="mx-auto max-w-5xl flex flex-col lg:flex-row gap-6 px-4 py-8 lg:px-6 lg:py-10">
              <div className="lg:w-1/2">
                ...
                <h1 className="mt-2 text-[22px] sm:text-[26px] font-semibold uppercase leading-snug tracking-[0.14em]">
                  Plans for extensions, lofts and conversions in Newham
                </h1>
                ...
                <p className="mt-3 text-[13px] text-slate-700">
                  We regularly work near Stratford Station, East Ham Station, Upton Park and Canning Town, covering
                  surrounding residential streets across the borough.
                </p>

                <p className="mt-3 text-[13px] text-slate-700">
                  Recent projects in Newham include rear extensions, side returns and loft conversions across East Ham,
                  Plaistow, Forest Gate and Stratford.
                </p>

                <ul className="mt-4 space-y-1 text-[13px] text-slate-800">
                  <li>• House extensions, wrap around extensions and internal remodelling</li>
                  <li>• Loft conversions including dormers and hip to gable options</li>
                  <li>• HMOs and flat conversions with practical layouts</li>
                  <li>• Shop to residential layout drawings where policies allow</li>
                  <li>• Planning drawings and building regulation packs</li>
                  <li>• Covering East Ham, Forest Gate, Stratford, Plaistow and more</li>
                ...
                <div className="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                  <div className="relative h-[170px] w-full">
                    <Image
                      ...
                      alt="Architectural drawings and planning packs in Newham"
                      fill
                  ...
                  <div className="p-4 text-[12px] text-slate-600">
                    Planning drawings, HMOs, flat conversion layouts and building regulation packs across Newham.
                  </div>
                </div>
              </div>
              ...
              <div id="newham-quote" className="lg:w-1/2">
                <div className="bg-white p-5 rounded-2xl shadow-md">
                  ...
                  <form onSubmit={handleSubmit} className="mt-3 space-y-3 text-[13px]">
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium">Newham postcode</label>
                      <input
                        name="postcode"
                        required
                        placeholder="E6, E7, E12, E13, E15 or E16"
                        onFocus={(e) => (e.target.placeholder = "")}
                        onBlur={(e) =>
                          !e.target.value && (e.target.placeholder = "E6, E7, E12, E13, E15 or E16")
                        }
                    ...
                    <div className="space-y-1">
                      ...
                      >
                        ...
                        <option>Shop to residential</option>
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        name="projectDetails"
                        rows={4}
                        placeholder="For example: rear extension and loft conversion to a terraced house in East Ham with open plan kitchen."
                    ...
                    <p className="text-[11px] text-slate-500 mt-2">
                      Typical Newham projects include rear extensions, loft conversions, flat conversions, HMOs and shop layout changes.
                    </p>
                  </form>
                </div>
              </div>
          ...
          <ServiceInternalLinks boroughName="Newham" />
          ...
          <section className="bg-white border-b border-slate-200 py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6 space-y-10">
              <div className="grid md:grid-cols-[1.7fr,1.3fr] gap-10 items-start">
                <div className="space-y-4">
                  ...
                  <p className="text-[13px] text-slate-700">
                    ...
                    internal alterations, HMOs, flat conversions, outbuildings, shop conversions and small new developments across the borough of Newham.
                  </p>
                  <p className="text-[13px] text-slate-700">
                    We work throughout East Ham, West Ham, Upton Park, Plaistow, Forest Gate, Manor Park, Canning Town,
                    Custom House, Beckton, Stratford, Maryland and the Royal Docks fringe.
                  </p>
              ...
              <div className="grid md:grid-cols-2 gap-10">
                <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
                  ...
                  <Image
                    ...
                    alt="Newham local area coverage"
                    width={800}
                    height={500}
                    className="rounded-xl object-cover mb-3"
                  />
                  <p className="text-[13px] text-slate-700">Drawings for the whole borough of Newham, including:</p>
                  <div className="grid grid-cols-2 gap-2 text-[13px] text-slate-700">
                    <ul className="list-disc pl-4 space-y-1">
                      <li>East Ham E6</li>
                      <li>Forest Gate E7</li>
                      <li>Manor Park E12</li>
                      <li>Plaistow E13</li>
                      <li>Stratford E15</li>
                      <li>Beckton E6 E16</li>
                    </ul>
                    <ul className="list-disc pl-4 space-y-1">
                      <li>Upton Park E13</li>
                      <li>Canning Town E16</li>
                      <li>Custom House E16</li>
                      <li>Maryland E15</li>
                      <li>West Ham E15</li>
                      <li>Royal Docks E16</li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="space-y-5">
                <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em]">
                  Permitted development and common limits in Newham
                </h2>
                <p className="text-[13px] text-slate-700">
                  This is a simplified guide to common permitted development limits for houses. Final confirmation depends on your house type, location and any restrictions. Flats and most HMOs require planning.
                </p>
              ...
              <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-6 space-y-3">
                ...
                <p className="text-[13px] text-emerald-900">
                  Newham includes dense terraces, mixed use streets and tighter plot conditions where daylight, amenity space, parking and access are closely reviewed. We shape each scheme to match local context and common approval patterns.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-6 text-[13px] text-slate-700">
                  <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                    <h3 className="font-semibold text-slate-900">Do I need planning permission in Newham</h3>
                    <p>
                      Many house extensions and lofts can proceed under permitted development. Flats and most HMOs require planning. We check your address and advise the best route at the start.
                    </p>
                  </div>
                  <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                    <h3 className="font-semibold text-slate-900">How fast can you survey</h3>
                    <p>In most cases we can arrange the initial measured survey within forty eight hours of instruction, subject to access.</p>
                  </div>
                  <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                    <h3 className="font-semibold text-slate-900">Do you submit to Newham Council</h3>
