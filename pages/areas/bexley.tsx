...
export default function BexleyAreaPage() {
  ...
  const localBusinessJson = {
    ...
    description:
      "Architectural drawings in Bexley for house extensions, loft conversions, refurbishments and new builds. Fixed fee planning and building regulation packs covering Bexleyheath, Welling, Sidcup, Erith and the wider borough.",
  };

  return (
    <>
      <Head>
        <title>Architectural Drawings in Bexley – Extensions, Lofts and New Builds</title>
        <meta
          name="description"
        ...
        <main>
              ...
              <div className="lg:w-1/2">
                ...
                <div className="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                  ...
                  <div className="p-3 text-[12px] text-slate-600">
                    Planning drawings, elevations and technical packs for home projects across Bexley.
                  </div>
                </div>
              </div>
          ...
          <section className="border-b border-slate-200 bg-white py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              ...
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                Streets in Bexley include many traditional family houses and bungalows,
                and many owners choose to extend rather than move further out. Our role
                is to prepare drawings and information that make it easier to secure
                permission and for builders and engineers to work accurately.
              </p>
              ...
              <div className="mt-5 grid gap-5 text-[13px] md:grid-cols-3">
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    We concentrate on extensions, lofts and small residential schemes,
                    so layouts, stairs, structure and glazing are set out with planning
                    and construction in mind from the start.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    You deal directly with the designers preparing your drawings. We keep
                    email and WhatsApp messages clear and practical so you know what is
                ...
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Every project receives a written fixed fee proposal. Options for
                    planning only, planning plus building regulation packs and further
                    support are set out before work begins.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="border-b border-slate-200 bg-[#f8f4f0] py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              ...
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                The borough covers Bexleyheath, Welling, Sidcup, Erith, Crayford, Belvedere
                and surrounding neighbourhoods. Typical projects include:
              </p>
              ...
              <div className="mt-5 grid gap-5 text-[13px] md:grid-cols-2">
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Single and double storey extensions to enlarge kitchens, dining rooms and
                    family spaces. We consider roof design, glazing and neighbour impact so
                    the scheme is practical and more likely to be supported.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Rear dormers, hip to gable lofts and L shaped conversions to add bedrooms
                    and bathrooms. Stairs, headroom and fire protection are set out clearly
                    for builders and building control.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Conversion of attached and detached garages or garden rooms into usable living
                    space, hobby rooms or offices. We plan openings, insulation and drainage so
                    technical approval is simpler.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Some side gardens and larger plots can support an extra home or pair of houses.
                    We test layout and access, then prepare full plans and elevations for planning
                    applications.
                  </p>
                </div>
              </div>
          ...
          <section className="border-b border-slate-200 bg-white py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              ...
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                Bexley follows its Local Plan alongside the London Plan. Many smaller extensions
                and lofts to houses can be carried out under permitted development, while larger
                schemes, conversions and new dwellings require full planning permission.
              </p>

              <ul className="mt-4 space-y-2 text-[13px] text-slate-800">
                <li>• We check whether your property benefits from permitted development rights and whether any Article 4 directions apply.</li>
              ...
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                If you are unsure whether your project in Bexley needs planning permission or can
                follow permitted development, we can outline the options and tailor the drawings
                accordingly.
              </p>
            </div>
          </section>
            ...
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              ...
              <div className="mt-5 grid gap-5 text-[13px] md:grid-cols-3">
                <div className="rounded-md border border-slate-200 bg-white p-4">
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    You share your outline ideas using the form or by phone. For many Bexley projects
                    we can start from your measurements and photos, and for others we arrange a measured survey.
                  </p>
                </div>
                ...
                <div className="rounded-md border border-slate-200 bg-white p-4">
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    We prepare design options where needed and then complete full plans and elevations.
                    Once you are happy, we submit drawings to the council and respond to plan comments.
                  </p>
                </div>
                ...
                <div className="rounded-md border border-slate-200 bg-white p-4">
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    After planning approval we can prepare building regulation drawings and coordinate with a
                    structural engineer so your chosen builder has a clear technical pack to work from.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="border-b border-slate-200 bg-white py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              ...
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                Fees for Bexley follow the same structure as the rest of London, with adjustments
                for size and complexity. A written fixed fee proposal is provided before any drawing work starts.
              </p>
              ...
              <div className="mt-5 grid gap-4 text-[13px] md:grid-cols-3">
                <div className="rounded-md border border-slate-200 bg-[#fdf8f3] p-4">
                  ...
                  <p className="mt-2 text-[12px] text-slate-600">
                    Existing and proposed plans and elevations for extensions and lofts to houses in
                    Bexleyheath, Welling, Sidcup, Crayford and nearby streets.
                  </p>
                </div>
                ...
                <div className="rounded-md border border-slate-200 bg-[#fdf8f3] p-4">
                  ...
                  <p className="mt-2 text-[12px] text-slate-600">
                    On site measured surveys where required so existing drawings accurately reflect your property
                ...
                <div className="rounded-md border border-slate-200 bg-[#fdf8f3] p-4">
                  ...
                  <p className="mt-2 text-[12px] text-slate-600">
                    Detailed technical drawings, sections and notes coordinated with structural engineers for
                    building control and contractors.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-6">
                <p className="max-w-3xl text-[13px] text-slate-700">
                  We support projects across the whole borough including Bexleyheath, Welling, Sidcup, Erith,
                  Crayford, Belvedere and surrounding areas.
                </p>
              </div>
          ...
          <section className="bg-[#f8f4f0] py-10">
            <div className="mx-auto max-w-5xl px-4 text-center lg:px-6">
              ...
              <p className="mt-3 text-[13px] text-slate-700">
                ...
                for your Bexley extension, loft conversion, refurbishment or small new build scheme.
              </p>
