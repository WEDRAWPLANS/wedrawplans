...
const WHATSAPP_LINK =
  "https://wa.me/442036548508?text=Hello%20WEDRAWPLANS%2C%20I%20would%20like%20a%20quote%20for%20plans%20in%20Sutton";

export default function SuttonAreaPage() {
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    await submitBoroughLead(e, { boroughName: "Sutton" });
  }

  function scrollToForm() {
    const el = document.getElementById("sutton-quote");
  ...
  const localBusinessJson = {
    ...
    "@type": "LocalBusiness",
    name: "WEDRAWPLANS",
    url: "https://www.wedrawplans.co.uk/areas/sutton",
  ...
  const faqJson = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Do I need planning permission for a rear extension in Sutton?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
      ...
      {
        "@type": "Question",
        name: "How long does Sutton Council take to decide?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
      ...
      {
        "@type": "Question",
        name: "Do you manage the full submission to Sutton Council?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
  ...
  return (
    <>
      <Head>
        <title>Architectural Drawings in Sutton | Extensions, Lofts, New Builds</title>
        <meta
          name="description"
          content="Architectural drawings in Sutton for house extensions, loft conversions, new builds and building regulation packs. Fixed fees with clear scope and fast turnaround."
        />
        <link rel="canonical" href="https://www.wedrawplans.co.uk/areas/sutton" />
        <script
      ...
      <div className="min-h-screen bg-[#f8f4f0] text-slate-900">
        ...
        <main>
            ...
            <div className="mx-auto max-w-5xl flex flex-col lg:flex-row gap-6 px-4 py-8 lg:px-6 lg:py-10">
              <div className="lg:w-1/2">
                <p className="text-[11px] font-semibold uppercase tracking-[0.26em] text-red-700">
                  Sutton architectural drawings
                </p>

                <h1 className="mt-2 text-[22px] sm:text-[26px] font-semibold uppercase leading-snug tracking-[0.14em]">
                  Plans for extensions, lofts and new builds in Sutton
                </h1>
              ...
              <div id="sutton-quote" className="lg:w-1/2">
                <div className="bg-white p-5 rounded-2xl shadow-md">
                  ...
                  <form onSubmit={handleSubmit} className="mt-3 space-y-3 text-[13px]">
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium">Sutton postcode</label>
                      <input
                        name="postcode"
                        required
                        placeholder="SM1 2AB"
                        onFocus={(e) => (e.target.placeholder = "")}
                        onBlur={(e) => !e.target.value && (e.target.placeholder = "SM1 2AB")}
          ...
          <ServiceInternalLinks boroughName="Sutton" />
            ...
            <div className="mx-auto max-w-5xl px-4 lg:px-6 space-y-10">
              <div className="grid md:grid-cols-[1.7fr,1.3fr] gap-10 items-start">
                <div className="space-y-4">
                  <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em]">
                    Architectural drawing services in Sutton
                  </h2>
                ...
                <div className="rounded-2xl bg-white shadow-md border border-slate-100 overflow-hidden">
                  <Image
                    ...
                    alt="Example of architectural drawings for a Sutton extension"
                    width={800}
                    height={500}
              ...
              <div className="grid md:grid-cols-2 gap-10">
                <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
                  ...
                  />
                  <p className="text-[13px] text-slate-700">Drawings for the whole borough of Sutton, including:</p>
              ...
              <div className="grid md:grid-cols-2 gap-10">
                ...
                <div className="rounded-2xl bg-white shadow-sm p-6 border border-slate-100 space-y-4">
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                    Building regulation drawings for Sutton
                  </h3>
                  <ul className="list-disc pl-4 space-y-1 text-[13px] text-slate-700">
