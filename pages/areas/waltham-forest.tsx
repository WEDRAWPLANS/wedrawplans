...
export default function WalthamForestAreaPage() {
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    alert(
      "Thank you. In the live site this form will email WEDRAWPLANS with your Waltham Forest enquiry and trigger a same day call back."
    );
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings in Waltham Forest – Extensions, Lofts and New Builds
        </title>
        <meta
          name="description"
          content="Architectural drawings in Waltham Forest for house extensions, loft conversions, flat conversions, new builds and building regulation packs. Fixed fees from £750 with fast turnaround."
        />
      </Head>
      ...
      <div className="min-h-screen bg-[#f8f4f0] text-slate-900">
        ...
        <main>
            ...
            <div className="mx-auto flex max-w-5xl flex-col gap-6 px-4 py-8 lg:flex-row lg:items-start lg:px-6 lg:py-10">
              ...
              <div className="lg:w-1/2">
                ...
                <h1 className="mt-2 text-[22px] font-semibold uppercase leading-snug tracking-[0.14em] text-slate-900 sm:text-[26px]">
                  Plans for extensions, lofts and new builds in Waltham Forest
                </h1>
                <p className="mt-3 text-[13px] text-slate-700">
                  ...
                  across the London Borough of Waltham Forest. Fixed fees with clear
                  scope and fast communication.
                </p>
                <ul className="mt-4 space-y-1 text-[13px] text-slate-800">
                  <li>• Extensions, lofts and internal remodelling</li>
                  <li>• Flat conversions and maisonettes</li>
              ...
              <div id="waltham-forest-quote" className="lg:w-1/2">
                <div className="rounded-2xl bg-white p-5 shadow-md">
                  <h2 className="text-[14px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                    Free fixed quote for Waltham Forest projects
                  </h2>
                  <p className="mt-1 text-[12px] text-slate-600">
                    Tell us a little about your property in Waltham Forest and what you plan to build. We will send a clear fixed fee for your drawings.
                  </p>
                  ...
                  <form onSubmit={handleSubmit} className="mt-3 space-y-3 text-[13px]">
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium text-slate-700">Waltham Forest postcode</label>
                      <input
                        name="postcode"
                        required
                        placeholder="E17 4AA"
                        ...
                        onBlur={(e) => {
                          if (!e.target.value) e.target.placeholder = "E17 4AA";
                        }}
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium text-slate-700">
                        Brief description of your Waltham Forest project
                      </label>
                      <textarea
                        name="projectDetails"
                        rows={4}
                        placeholder="For example: loft conversion + internal reconfiguration to terrace in Walthamstow with new open plan layout."
                    ...
                    <p className="mt-2 text-[11px] text-slate-500">
                      Typical Waltham Forest projects include extensions and loft
                      conversions to Victorian, Edwardian and 1930s terraces, as well as
                      flat conversions and new build infill plots.
                    </p>
                  </form>
                </div>
              </div>
          ...
          <section className="border-b border-slate-200 bg-white py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Common project types in Waltham Forest
              </h2>
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                Waltham Forest has a large stock of Victorian terraces, Edwardian homes,
                1930s semis and modern apartments. Many owners extend, remodel or convert
                lofts to create brighter, more flexible layouts.
              </p>
              <div className="mt-5 grid gap-5 text-[13px] md:grid-cols-2">
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Rear kitchen extensions and side infills are popular throughout
                    Walthamstow, Leyton and Leytonstone. We set out structure, glazing and
                    daylight carefully within suburban plots.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Dormer lofts, hip to gable conversions and L-shape dormers (Victorian)
                    are all common. We design efficient layouts with stairs, fire
                    protection and headroom requirements in mind.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Many larger properties are split into self-contained flats or
                    maisonettes. We prepare layouts, stacking positions, escape routes and
                    amenity considerations in line with local policy.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Side plots, garage sites and rear gardens sometimes offer opportunities
                    for new houses. We prepare complete planning packages including plans,
                    elevations and supporting statements.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="border-b border-slate-200 bg-[#f8f4f0] py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Areas of Waltham Forest covered
              </h2>
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
              ...
              <ul className="mt-4 grid gap-2 text-[13px] text-slate-800 md:grid-cols-2">
                <li>• Walthamstow and Upper Walthamstow</li>
                <li>• Leyton and Leytonstone</li>
                <li>• Chingford and Highams Park</li>
                <li>• Chapel End and Wood Street</li>
                <li>• South Chingford and Cann Hall</li>
                <li>• Surrounding neighbourhoods within the borough</li>
              </ul>
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                We can manage projects fully online or combine them with an on-site measured
                survey where needed.
              </p>
            </div>
          </section>
          ...
          <section className="border-b border-slate-200 bg-white py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Clear fixed fees for Waltham Forest projects
              </h2>
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                Fees for Waltham Forest projects follow the same clear structure as the rest
              ...
              <div className="mt-5 grid gap-4 text-[13px] md:grid-cols-3">
                ...
                <div className="rounded-md border border-slate-200 bg-[#fdf8f3] p-4">
                  <h3 className="text-[13px] font-semibold text-slate-900">
                    Measured survey in Waltham Forest
                  </h3>
                  <div className="mt-1 text-[13px] font-semibold text-slate-900">
                    from £150 + VAT
                  </div>
                  <p className="mt-2 text-[12px] text-slate-600">
                    On site survey of your property so accurate existing drawings can be
                    prepared before design work begins.
                  </p>
                </div>
          ...
          <section className="bg-[#f8f4f0] py-10">
            <div className="mx-auto max-w-5xl px-4 text-center lg:px-6">
              <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Ready to move your Waltham Forest project forward
              </h2>
              <p className="mt-3 text-[13px] text-slate-700">
                Share a few details and WEDRAWPLANS will reply with a clear fixed fee and
                suggested next steps for your Waltham Forest extension, loft, new build or
                technical pack.
              </p>
