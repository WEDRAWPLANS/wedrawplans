...
const HILLINGDON_AREA_IMAGE = "/images/hillingdon-area.jpg";
const HILLINGDON_VIDEO = "/videos/hillingdon-planning-project.mp4";
...
export default function HillingdonAreaPage() {
  ...
  const localBusinessJson = useMemo(
    () => ({
      ...
      image: "https://www.wedrawplans.co.uk/images/hillingdon-hero.jpg",
      address: {
        "@type": "PostalAddress",
      ...
      description:
        "Architectural drawing services in Hillingdon for extensions, loft conversions, planning applications, garage conversions, outbuildings, conversions and Building Regulation packs. Fixed fees, clear scope, initial survey within 48 hours and fast communication.",
  ...
  const faqJson = useMemo(
    () => ({
      ...
      mainEntity: [
        {
          "@type": "Question",
          name: "Do I need planning permission for a rear extension in Hillingdon",
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "Not always. Many rear extensions in Hillingdon can be permitted development depending on house type, depth, height, location and any restrictions affecting the property. Conservation areas and Article 4 controls can change what is allowed, so we confirm the correct route after checking your address.",
          },
        },
        {
          "@type": "Question",
          name: "Are loft conversions usually approved in Hillingdon",
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "Many loft conversions are acceptable where the design is proportionate and suits the existing roof form and street character. Careful design is important where visible roof changes, neighbour impact or local planning constraints apply.",
          },
        },
        {
          "@type": "Question",
          name: "How long does Hillingdon Council take to decide planning applications",
          acceptedAnswer: {
            "@type": "Answer",
            text:
        ...
        {
          "@type": "Question",
          name: "Do you manage the submission to Hillingdon Council",
          acceptedAnswer: {
            "@type": "Answer",
            text:
        ...
        {
          "@type": "Question",
          name: "Can you prepare Building Regulation drawings for Hillingdon projects",
          acceptedAnswer: {
            "@type": "Answer",
            text:
        ...
        {
          "@type": "Question",
          name: "How quickly can you carry out a measured survey in Hillingdon",
          acceptedAnswer: {
            "@type": "Answer",
            text:
        ...
        {
          "@type": "Question",
          name: "What drawings are usually required for a Hillingdon planning submission",
          acceptedAnswer: {
            "@type": "Answer",
            text:
        ...
        {
          "@type": "Question",
          name: "Do you cover Uxbridge, Hayes, Ruislip and West Drayton",
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "Yes. We cover the wider borough including Uxbridge, Hayes, Ruislip, Ruislip Manor, Ickenham, West Drayton, Yiewsley, Hillingdon Village, Eastcote, Northwood and nearby areas.",
          },
        },
        {
          "@type": "Question",
          name: "Can you help with outbuildings and garden rooms in Hillingdon",
          acceptedAnswer: {
            "@type": "Answer",
            text:
  ...
  return (
    <>
      <Head>
        <title>Architectural Drawings in Hillingdon | Planning and Building Regs Plans</title>
        <meta
          name="description"
          content="Architectural drawings in Hillingdon for extensions, loft conversions, planning applications and Building Regulation packs. Fixed fees, clear scope, initial survey within 48 hours and fast communication."
        />
        <meta
          name="keywords"
          content="architectural drawings Hillingdon, extension drawings Hillingdon, loft conversion drawings Hillingdon, planning drawings Hillingdon, building regulation drawings Hillingdon, architectural plans Uxbridge, Hayes, Ruislip, West Drayton"
        />
      ...
      <div className="min-h-screen bg-[#f8f4f0] text-slate-900">
        ...
        <main>
          <section className="border-b border-slate-200 bg-[#fdf8f3]">
            <div className="mx-auto max-w-6xl px-4 py-8 lg:px-6 lg:py-10">
              <div className="grid gap-8 lg:grid-cols-[1.06fr,0.94fr] lg:items-stretch">
                <div className="space-y-5">
                  <div>
                    ...
                    <h1 className="mt-2 text-[22px] font-semibold uppercase leading-snug tracking-[0.14em] text-slate-900 sm:text-[27px]">
                      Architectural Drawings in Hillingdon for Extensions, Lofts and Building Regs
                    </h1>
                  ...
                  <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-md">
                    <Image
                      src={HERO_IMAGE}
                      alt="Architectural drawings and home improvement visual for a Hillingdon project"
                      width={1400}
                      height={950}
                      priority
                  ...
                  <p className="text-[13px] leading-7 text-slate-700">
                    ...
                    London Borough of Hillingdon. We focus on approval ready submissions, practical layouts and
                  ...
                  <p className="text-[13px] leading-7 text-slate-700">
                    We work across Uxbridge, Hayes, Ruislip, Ruislip Manor, Ruislip Gardens, Ickenham,
                    West Drayton, Yiewsley, Hillingdon Village, Eastcote, Northwood, Northwood Hills,
                    Harefield and nearby areas. If you are in UB3, UB4, UB7, UB8, UB10, HA4 or close by,
                    we can advise quickly on the likely planning route and the drawings most suitable for your project.
                  </p>

                  <p className="text-[13px] leading-7 text-slate-700">
                    Common local enquiries include rear extensions to semi detached and detached houses,
                    wraparound kitchen enlargements, loft dormers, garage conversions, internal reconfiguration
                    and technical packs for projects moving into construction. Hillingdon projects often need a
                    practical suburban design response that balances space gain, build cost, neighbour impact
                    and planning acceptability.
                  </p>
                  ...
                  <div className="grid gap-3 sm:grid-cols-3">
                    ...
                    <TrustPill title="Hillingdon aware" body="Prepared for real local planning routes." />
                  </div>
                  ...
                  <ul className="space-y-1 text-[13px] text-slate-800">
                    ...
                    <li>• Covering Uxbridge, Hayes, Ruislip, Ickenham and West Drayton</li>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                    <div className="text-[12px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                      Fast route for Hillingdon homeowners
                    </div>
                ...
                <div id="hillingdon-quote" className="space-y-6">
                  <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-md">
                    <div className="p-5">
                      <div className="text-[12px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                        Built for Hillingdon homeowners
                      </div>
                      ...
                      <form onSubmit={handleSubmit} className="mt-4 space-y-3 text-[13px]">
                        ...
                        <div className="space-y-1">
                          <label className="text-[11px] font-medium text-slate-700">Hillingdon postcode</label>
                          <input
                            name="postcode"
                            required
                            placeholder="UB10 9LZ"
                            onFocus={(e) => {
                              e.target.placeholder = "";
                            }}
                            onBlur={(e) => {
                              if (!e.target.value) e.target.placeholder = "UB10 9LZ";
                            }}
                        ...
                        <div className="space-y-1">
                          ...
                          <textarea
                            name="projectDetails"
                            rows={4}
                            placeholder="For example: single storey rear extension in Uxbridge with a larger kitchen diner and improved garden access."
                  ...
                  <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-md">
                    <Image
                      ...
                      alt="Hillingdon local streets and housing context"
                      width={1200}
                      height={900}
              ...
              <div className="mt-6 grid items-stretch gap-6 md:grid-cols-2">
                <div className="overflow-hidden rounded-2xl border border-slate-200 bg-black shadow-lg">
                  <video controls playsInline preload="metadata" className="h-full w-full object-cover">
                    <source src={HILLINGDON_VIDEO} type="video/mp4" />
            ...
            <div className="mx-auto max-w-5xl space-y-10 px-4 lg:px-6">
              <div className="grid items-start gap-10 md:grid-cols-[1.25fr,0.95fr]">
                <div className="space-y-4">
                  ...
                  <p className="text-[13px] leading-7 text-slate-700">
                    WEDRAWPLANS deliver planning drawings and technical packs for Hillingdon homeowners and property
                  ...
                  <p className="text-[13px] leading-7 text-slate-700">
                    We work throughout Uxbridge, Hayes, Ruislip, Ickenham, West Drayton, Yiewsley, Eastcote,
                    Northwood, Harefield and nearby areas. If you are in UB3, UB4, UB7, UB8, UB10 or HA4,
                  ...
                  <div className="grid gap-4 pt-2 sm:grid-cols-2">
                    ...
                    <div className="rounded-2xl border border-slate-100 bg-slate-50 p-5">
                      ...
                      <ul className="mt-3 list-disc space-y-1 pl-5 text-[13px] text-slate-700">
                        ...
                        <li>Hillingdon specific planning route guidance</li>
                ...
                <div className="space-y-6">
                  <div className="overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-md">
                    <Image
                      ...
                      alt="Architectural drawings laid out neatly for a Hillingdon project"
                      width={800}
                      height={500}
                  ...
                  <div className="overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-md">
                    <Image
                      src={HILLINGDON_LOCAL_IMAGE}
                      alt="Hillingdon area coverage image showing local streets and housing"
                      width={800}
                      height={500}
                      className="h-56 w-full object-cover"
                    />
                    <div className="space-y-2 p-5">
                      ...
                      <p className="text-[13px] leading-7 text-slate-700">
                        We support homeowners across Hillingdon with measured surveys, design development
              ...
              <div className="grid gap-10 md:grid-cols-2">
                <div className="space-y-4 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                  ...
                  <Image
                    src={HILLINGDON_AREA_IMAGE}
                    alt="Hillingdon streets and local housing across Uxbridge Hayes Ruislip and surrounding areas"
                    width={800}
                    height={500}
                ...
                <div className="space-y-4 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                  ...
                  <Image
                    src={PROJECT_IMAGE_1}
                    alt="Completed Hillingdon extension and loft project"
                    width={800}
                    height={500}
              ...
              <div className="space-y-5">
                ...
                <p className="text-[13px] text-slate-700">
                  Hillingdon homeowners often want more than drawings. They want clarity on what changes are achievable,
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                    <Image
                      src={PROJECT_IMAGE_1}
                      alt="Hillingdon extension drawings presentation"
                      width={900}
                      height={700}
                  ...
                  <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                    <Image
                      src={PROJECT_IMAGE_2}
                      alt="Technical drawing set and completed Hillingdon project visual"
                      width={900}
                      height={700}
                      className="h-64 w-full object-cover"
                    />
              ...
              <div className="space-y-5">
                ...
                <p className="text-[13px] text-slate-700">
                  ...
                  and sensitive local conditions.
                </p>
              ...
              <div className="grid gap-10 md:grid-cols-2">
                <div className="space-y-4 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                  ...
                  <p className="text-[13px] leading-7 text-slate-700">
                    Our Hillingdon planning drawings are set out for smooth validation and clear review. We make sure
                ...
                <div className="space-y-4 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                  ...
                  <p className="text-[13px] leading-7 text-slate-700">
                    Our Hillingdon building regs packs focus on buildability and compliance. They reduce site questions,
              ...
              <div className="space-y-3 rounded-2xl border border-emerald-100 bg-emerald-50 p-6">
                ...
                <p className="text-[13px] leading-7 text-emerald-900">
                  Hillingdon includes a wide mix of suburban streets, larger family houses, semis, detached homes and
                  streets where massing, roof form, parking impact and neighbour relationships are assessed carefully.
                  We shape each scheme to suit local character so approval confidence is as strong as possible while
                  keeping the layout practical for build cost, natural light and space gain.
                </p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-6 text-[13px] text-slate-700 md:grid-cols-2">
                  ...
                  <div className="space-y-2 rounded-xl border border-slate-100 bg-white p-4">
                    <h3 className="font-semibold text-slate-900">Do you cover Uxbridge and Ruislip</h3>
                    <p>
                      Yes. We cover Uxbridge, Hayes, Ruislip, Ickenham, West Drayton, Yiewsley and nearby areas.
                  ...
                  <div className="space-y-2 rounded-xl border border-slate-100 bg-white p-4">
                    <h3 className="font-semibold text-slate-900">
                      How do you help approval chances in Hillingdon
                    </h3>
                    <p>
                      We set out clear dimensions, neighbour relationships and a proportionate design approach. We also
                      focus on practical layouts and a clean submission so the proposal reads well to planners.
                    </p>
                  </div>
          ...
          <section className="bg-[#f8f4f0] py-10">
            <div className="mx-auto max-w-5xl px-4 text-center lg:px-6">
              ...
              <p className="mt-3 text-[13px] text-slate-700">
                ...
                your Hillingdon extension, loft conversion, refurbishment, garage conversion or small development project.
              </p>
          ...
          <SmartPlanningAssistant boroughName="Hillingdon" />
        </main>
          ...
          <div className="mx-auto max-w-6xl px-4 py-10 lg:px-6">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-4 max-w-2xl text-[13px] leading-7 text-white/80">
                ...
                Building Regulations and small residential development projects across Hillingdon, Uxbridge, Hayes,
                Ruislip, Ickenham, West Drayton and surrounding areas.
              </p>
