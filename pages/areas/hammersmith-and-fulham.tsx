...
"@type": "Answer",
text:
"Yes. We prepare existing and proposed drawings for extensions and advise on the typical submission route after reviewing your address and proposal.",
},
},
{
"@type": "Question",
name: "Can you produce building regulation drawings for my project",
acceptedAnswer: {
"@type": "Answer",
text:
"Yes. We can produce a full building regulation pack including plans, sections, key details and coordination notes for building control.",
},
},
{
"@type": "Question",
...
"@type": "Answer",
text:
"Yes. We can arrange an on site measured survey when accurate existing drawings are needed to start the design quickly.",
},
},
{
"@type": "Question",
...
<meta name="description" content="Architectural drawings in Hammersmith and Fulham for extensions, loft conversions, flat conversions and building regulation packs. Fixed fees from £750 with fast turnaround." />
        ...
        <div className="mx-auto max-w-5xl flex flex-col lg:flex-row gap-6 px-4 py-8 lg:px-6 lg:py-10">
          <div className="lg:w-1/2">
            ...
            <p className="mt-3 text-[13px] text-slate-700">
              WEDRAWPLANS prepare planning and building regulation drawing packages across Hammersmith and Fulham,
            ...
            <ul className="mt-4 space-y-1 text-[13px] text-slate-800">
              ...
              <li>• Loft conversions with dormers and roof alterations</li>
              <li>• Flat conversions and technical packs</li>
              ...
              <form onSubmit={handleSubmit} className="mt-3 space-y-3 text-[13px]">
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    name="projectDetails"
                    rows={4}
                    placeholder="Example: rear extension in Fulham with loft conversion above."
                ...
                <p className="mt-2 text-[11px] text-slate-500">
                  Typical projects: extensions, lofts, flat conversions and building regulation packs across Hammersmith and Fulham.
                </p>
              </form>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
              <div className="relative h-44 w-full">
                <Image
                  src="/images/hero.jpg"
                  alt="Extensions and refurbishment design support"
                  fill
                  className="object-cover"
                />
              </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
              <div className="relative h-44 w-full">
                <Image
                  src="/images/drawings.jpg"
                  alt="Building regulation drawings and technical detailing"
                  fill
                  className="object-cover"
                />
              </div>
