...
export default function HarrowAreaPage() {
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    alert(
      "Thank you. In the live site this form will email WEDRAWPLANS with your Harrow enquiry and trigger a same day call back."
    );
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings in Harrow – Extensions, Lofts and New Builds
        </title>
        <meta
          name="description"
        ...
        <main>
            ...
            <div className="mx-auto max-w-5xl flex flex-col lg:flex-row gap-6 px-4 py-8 lg:px-6 lg:py-10">
              ...
              <div className="lg:w-1/2">
                ...
                <ul className="mt-4 space-y-1 text-[13px] text-slate-800">
                  ...
                  <li>• Covering Harrow, Harrow Weald, Wealdstone, Kenton, Stanmore & more</li>
                  ...
                  <form onSubmit={handleSubmit} className="mt-3 space-y-3 text-[13px]">
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        ...
                        className="w-full border border-slate-300 rounded bg-white px-2 py-2 focus:border-[#64b7c4]"
                      />
                    </div>
                    ...
                    <p className="text-[11px] text-slate-500 mt-2">
                      Typical Harrow projects include extensions, lofts and new build
                      infill developments across Harrow, Kenton and Harrow Weald.
                    </p>
                  </form>
                </div>
              </div>
          ...
          <section className="bg-white border-b border-slate-200 py-10">
            <div className="max-w-5xl mx-auto px-4 lg:px-6">
              ...
              <p className="mt-3 text-[13px] max-w-3xl text-slate-700">
                Harrow consists mainly of 1930s semis, detached houses and suburban
                family homes. Many owners extend, convert lofts or remodel layouts
                to increase space without moving.
              </p>

              <div className="grid md:grid-cols-2 gap-5 mt-5 text-[13px]">

                <div>
                  <h3 className="text-[14px] uppercase font-semibold tracking-[0.14em]">Rear & side extensions</h3>
                  <p className="mt-2 text-slate-700">
                    Large kitchen extensions and wrap-around schemes are common across
                    Harrow, Kenton and Harrow Weald. We design efficient layouts with
                    daylight and structure planned carefully.
                  </p>
                </div>

                <div>
                  <h3 className="text-[14px] uppercase font-semibold tracking-[0.14em]">Loft conversions</h3>
                  <p className="mt-2 text-slate-700">
                    Dormer lofts and hip-to-gable conversions add bedrooms and bathrooms
                    to Harrow homes. We set out stairs, headroom and fire protection
                ...
                <div>
                  <h3 className="text-[14px] uppercase font-semibold tracking-[0.14em]">
                    New build & backland developments
                  </h3>
                  <p className="mt-2 text-slate-700">
                    Side plots, garages and deep gardens often offer opportunities for a
                    new home. We prepare full planning drawing packages.
                  </p>
                </div>

                <div>
                  <h3 className="text-[14px] uppercase font-semibold tracking-[0.14em]">Flat conversions</h3>
                  <p className="mt-2 text-slate-700">
                    Suitable houses can be converted into self-contained flats. We prepare
                    layouts and amenity plans in line with Harrow’s planning standards.
                  </p>
                </div>
          ...
          <section className="bg-[#f8f4f0] border-b border-slate-200 py-10">
            <div className="max-w-5xl mx-auto px-4 lg:px-6">
              ...
              <ul className="grid md:grid-cols-2 gap-2 mt-4 text-[13px] text-slate-800">
                <li>• Harrow & Harrow on the Hill</li>
                <li>• Harrow Weald</li>
                <li>• Kenton & Queensbury</li>
                <li>• Stanmore & Belmont</li>
                <li>• Wealdstone</li>
                <li>• Rayners Lane & South Harrow</li>
              </ul>
          ...
          <section className="bg-white border-b border-slate-200 py-10">
            <div className="max-w-5xl mx-auto px-4 lg:px-6">
              ...
              <p className="mt-3 text-[13px] max-w-3xl text-slate-700">
                Fees follow the same clear structure as the rest of London, adjusted
                for size, complexity and planning requirements.
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-4 mt-5 text-[13px]">
                ...
                <div className="p-4 bg-[#fdf8f3] border border-slate-200 rounded-md">
                  ...
                  <p className="mt-2 text-[12px] text-slate-600">
                    Existing & proposed plans & elevations for planning applications.
                  </p>
                </div>
                ...
                <div className="p-4 bg-[#fdf8f3] border border-slate-200 rounded-md">
                  ...
                  <p className="mt-2 text-[12px] text-slate-600">
                    Fully detailed construction drawings & sections coordinated with structural engineers.
                  </p>
                </div>
          ...
          <section className="bg-[#f8f4f0] py-10">
            <div className="max-w-5xl mx-auto text-center px-4 lg:px-6">
              ...
              <p className="mt-3 text-[13px] text-slate-700">
                ...
                and recommended next steps for your Harrow extension, loft, conversion or new build.
              </p>
