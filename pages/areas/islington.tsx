...
export default function IslingtonAreaPage() {
  ...
  const localBusinessJson = {
    ...
    description:
      "Architectural drawing services in Islington for extensions, loft conversions, refurbishments, flat conversions and building regulation packs.",
  };
            ...
            <div className="mx-auto max-w-5xl flex flex-col lg:flex-row gap-6 px-4 py-8 lg:px-6 lg:py-10">
              ...
              <div className="lg:w-1/2">
                ...
                <p className="mt-3 text-[13px] text-slate-700">
                  ...
                  across the London Borough of Islington. Fixed fees with clear
                ...
                <ul className="mt-4 space-y-1 text-[13px] text-slate-800">
                  ...
                  <li>
                    • Covering Angel, Highbury, Canonbury, Holloway, Archway and
                    more
                  </li>
...
/>
              ...
              <div className="grid md:grid-cols-2 gap-10">
                ...
                <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
                  ...
                  <Image
                    src="/images/hero.jpg"
                    alt="Example project image for extensions and lofts"
                    width={800}
                    height={500}
              ...
              <div className="space-y-5">
                ...
                <p className="text-[13px] text-slate-700">
                  ...
                  limits. Final confirmation depends on your house type, location
                  and any Article 4 directions or conservation constraints.
                </p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-6 text-[13px] text-slate-700">
                  <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                    ...
                    <p>
                      Some houses can proceed under permitted development, but
                      flats and many conservation areas require planning
                      permission. We check your address and advise the best route
                      at the start.
                    </p>
                  </div>
                  <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                  ...
                  <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                    ...
                    <p>
                      Yes. We handle the submission, monitor progress and respond
