...
export default function RichmondAreaPage() {
  ...
  const localBusinessJson = {
    ...
    description:
      "Architectural drawing services in Richmond upon Thames for extensions, loft conversions, refurbishments, conversions and building regulations.",
  };
            ...
            <div className="mx-auto max-w-5xl px-4 lg:px-6 space-y-10">
              <div className="grid md:grid-cols-[1.7fr,1.3fr] gap-10 items-start">
                <div className="space-y-4">
                  ...
                  <p className="text-[13px] text-slate-700">
                    We work throughout Richmond, Twickenham, St Margarets, Kew, Barnes, Mortlake, East Sheen,
                    North Sheen, Teddington, Hampton, Hampton Wick, Petersham, Ham and Whitton.
                  </p>
                ...
                <div className="rounded-2xl bg-white shadow-md border border-slate-100 overflow-hidden">
                  <Image
                    ...
                    alt="Example of architectural drawings for a Richmond extension"
                    width={800}
                    height={500}
