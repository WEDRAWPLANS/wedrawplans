...
const WHATSAPP_LINK =
  "https://wa.me/442036548508?text=Hello%20WEDRAWPLANS%2C%20I%20would%20like%20a%20quote%20for%20plans%20in%20Lewisham";

export default function LewishamAreaPage() {
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
    const data = new FormData(e.currentTarget);
    console.log(Object.fromEntries(data.entries()));
    alert(
      "Thank you. In the live site this form will email WEDRAWPLANS with your Lewisham enquiry and trigger a same day call back."
    );
    e.currentTarget.reset();
  }

  function scrollToForm() {
    const el = document.getElementById("lewisham-quote");
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings in Lewisham – Extensions, Lofts and New Builds
        </title>
        <meta
          name="description"
      ...
      <div className="min-h-screen bg-[#f8f4f0] text-slate-900">
        ...
        <main>
            ...
            <div className="mx-auto flex max-w-5xl flex-col gap-6 px-4 py-8 lg:flex-row lg:items-start lg:px-6 lg:py-10">
              ...
              <div className="lg:w-1/2">
                ...
                <h1 className="mt-2 text-[22px] font-semibold uppercase leading-snug tracking-[0.14em] text-slate-900 sm:text-[26px]">
                  Plans for extensions, lofts and new builds in Lewisham
                </h1>
                <p className="mt-3 text-[13px] text-slate-700">
                  ...
                  across the London Borough of Lewisham. Fixed fees with clear
                ...
                <ul className="mt-4 space-y-1 text-[13px] text-slate-800">
                  ...
                  <li>• Covering Lewisham, Catford, Brockley, Forest Hill, Deptford and more</li>
              ...
              <div id="lewisham-quote" className="lg:w-1/2">
                <div className="rounded-2xl bg-white p-5 shadow-md">
                  <h2 className="text-[14px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                    Free fixed quote for Lewisham projects
                  </h2>
                  <p className="mt-1 text-[12px] text-slate-600">
                    Tell us a little about your property in Lewisham and what you
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        name="postcode"
                        required
                        placeholder="SE13 6AA"
                        onFocus={(e) => {
                          e.target.placeholder = "";
                        }}
                        onBlur={(e) => {
                          if (!e.target.value) {
                            e.target.placeholder = "SE13 6AA";
                          }
                        }}
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium text-slate-700">
                        Brief description of your Lewisham project
                      </label>
                      <textarea
                        name="projectDetails"
                        rows={4}
                        placeholder="For example: rear extension and loft conversion to a Victorian terrace in Lewisham with open plan kitchen and extra bedroom."
                    ...
                    <p className="mt-2 text-[11px] text-slate-500">
                      Typical Lewisham projects include extensions and loft conversions
                      to Victorian terraces and semis, flat conversions and new build
                      houses on side or backland plots.
                    </p>
                  </form>
                </div>
              </div>
          ...
          <section className="border-b border-slate-200 bg-white py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Common project types in Lewisham
              </h2>
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                Lewisham has a large stock of Victorian and Edwardian terraces,
                interwar semis and post war housing. Many owners extend, convert lofts
                or reconfigure layouts to create more usable family space rather than move.
              </p>
              <div className="mt-5 grid gap-5 text-[13px] md:grid-cols-2">
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    ...
                    side return infills to create larger open plan spaces. We set out
                    structure, layout and light carefully and consider neighbour impact.
                  </p>
                </div>
                <div>
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Rear dormer and hip to gable lofts are very common across Lewisham,
                    Brockley, Forest Hill and Catford. We design efficient layouts with
                    stairs, headroom and fire protection in mind.
                  </p>
                </div>
                <div>
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Larger houses and corner plots can sometimes be converted into self
                    contained flats. We set out unit layouts, access and basic amenity
                    considerations and coordinate with planning advice and standards.
                  </p>
                </div>
                <div>
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Many sites have potential for an additional house or small residential
                    scheme, especially near town centres and transport links. We prepare
                    layouts, elevations and information suitable for planning applications.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="border-b border-slate-200 bg-[#f8f4f0] py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              ...
              <ul className="mt-4 grid gap-2 text-[13px] text-slate-800 md:grid-cols-2">
                <li>• Lewisham, Hither Green and Ladywell</li>
                <li>• Catford, Bellingham and Downham</li>
                <li>• Brockley, Crofton Park and Honor Oak</li>
                <li>• Forest Hill and Sydenham</li>
                <li>• Deptford and New Cross</li>
          ...
          {/* PRICING REMINDER */}
          <section className="border-b border-slate-200 bg_white py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Clear fixed fees for Lewisham projects
              </h2>
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                Fees for Lewisham projects follow the same clear structure as the
          ...
          <section className="bg-[#f8f4f0] py-10">
            <div className="mx-auto max-w-5xl px-4 text-center lg:px-6">
              <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Ready to move your Lewisham project forward
              </h2>
              <p className="mt-3 text-[13px] text-slate-700">
                Share a few details and WEDRAWPLANS will reply with a clear fixed
                fee and suggested next steps for your Lewisham extension, loft,
