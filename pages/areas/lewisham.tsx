...
export default function LewishamAreaPage() {
  ...
  const localBusinessJson = {
    ...
    "@type": "LocalBusiness",
    name: "WEDRAWPLANS",
    url: "https://www.wedrawplans.co.uk/areas/lewisham",
    ...
    description:
      "Architectural drawing services in Lewisham for extensions, loft conversions, outbuildings, flats and building regulation packs.",
  };
  ...
  return (
    <>
      <Head>
        <title>Architectural Drawings in Lewisham | Extensions, Lofts, New Builds</title>
        <meta
          name="description"
          content="Architectural drawings in Lewisham for house extensions, loft conversions, outbuildings, flat conversions and building regulation packs. Fixed fees with clear scope and fast communication."
        />
        <link rel="canonical" href="https://www.wedrawplans.co.uk/areas/lewisham" />
          ...
          <div className="mx-auto max-w-6xl px-4 pt-6 pb-3 lg:px-6">
            ...
            <div className="mt-2 flex w-full items-center justify-between gap-3">
              <div className="text-[12px] text-slate-700">
                <span className="font-semibold text-slate-900">Lewisham</span> borough page
              </div>
            ...
            <div className="mx-auto max-w-5xl flex flex-col lg:flex-row gap-6 px-4 py-8 lg:px-6 lg:py-10">
              <div className="lg:w-1/2">
                ...
                <ul className="mt-4 space-y-1 text-[13px] text-slate-800">
                  ...
                  <li>• Covering Brockley, Crofton Park, New Cross, Deptford, Catford and more</li>
              ...
              <div id="lewisham-quote" className="lg:w-1/2">
                <div className="bg-white p-5 rounded-2xl shadow-md">
                  ...
                  <form onSubmit={handleSubmit} className="mt-3 space-y-3 text-[13px]">
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium">Lewisham postcode</label>
                      <input
                        name="postcode"
                        required
                        placeholder="SE4 2AA"
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        name="projectDetails"
                        rows={4}
                        placeholder="For example: rear and side extension to a Victorian terrace plus a dormer loft room."
                    ...
                    <p className="text-[11px] text-slate-500 mt-2">
                      Typical Lewisham projects include rear extensions, loft conversions and flat layout upgrades.
                    </p>
                  </form>
                </div>
              </div>
          ...
          <section className="bg-white border-b border-slate-200 py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6 space-y-10">
              <div className="grid md:grid-cols-[1.7fr,1.3fr] gap-10 items-start">
                ...
                <div className="rounded-2xl bg-white shadow-md border border-slate-100 overflow-hidden">
                  <Image
                    ...
                    alt="Example of architectural drawings for a Lewisham extension"
                    width={800}
                    height={500}
              ...
              <div className="grid md:grid-cols-2 gap-10">
                <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-[13px] text-slate-700">
                    <ul className="list-disc pl-4 space-y-1">
                      <li>Brockley SE4</li>
                      <li>Crofton Park SE4</li>
                      <li>New Cross SE14</li>
                      <li>Deptford SE8</li>
                      <li>Forest Hill SE23</li>
                      <li>Honor Oak SE23</li>
                    </ul>
                    <ul className="list-disc pl-4 space-y-1">
                      <li>Sydenham SE26</li>
                      <li>Catford SE6</li>
                      <li>Hither Green SE13</li>
                      <li>Lee SE12</li>
                ...
                <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                    Popular projects in Lewisham
                  </h3>
                  <div className="grid grid-cols-2 gap-3 text-[13px] text-slate-700">
                    <ul className="list-disc pl-4 space-y-1">
                      <li>Rear and wrap extensions</li>
                      <li>Side infill and kitchen reworks</li>
              ...
              <div className="space-y-5">
                <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em]">
                  Permitted development limits in Lewisham
                </h2>
                <p className="text-[13px] text-slate-700">
              ...
              <div className="grid md:grid-cols-2 gap-10">
                <div className="rounded-2xl bg-white shadow-sm p-6 border border-slate-100 space-y-4">
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                    Planning drawings for Lewisham
                  </h3>
              ...
              <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-6 space-y-3">
                ...
                <p className="text-[13px] text-emerald-900">
                  Lewisham includes conservation areas, character terraces and hilly streets where daylight, height and massing are closely assessed. We shape each scheme to fit local context so approval chances are as strong as possible.
                </p>
              </div>
