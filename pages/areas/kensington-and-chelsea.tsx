...
export default function KensingtonAndChelseaAreaPage() {
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    await submitBoroughLead(e, { boroughName: "Kensington and Chelsea" });
  }

  function scrollToForm() {
    const el = document.getElementById("kensington-and-chelsea-quote");
  ...
  const localBusinessJson = {
    ...
    "@type": "LocalBusiness",
    name: "WEDRAWPLANS",
    url: "https://www.wedrawplans.co.uk/areas/kensington-and-chelsea",
    ...
    areaServed: [
      ...
      "Chelsea Harbour area",
    ],
    description:
      "Architectural drawing services in Kensington and Chelsea for extensions, loft conversions, refurbishments, basements and building regulations.",
  };
  ...
  const faqJson = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Do I need planning permission for a rear extension in Kensington and Chelsea?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Not always. Some rear extensions can be carried out under permitted development, but many streets have tighter controls, conservation areas, or Article 4 directions. We confirm the correct route once we review your address and house type.",
        },
      },
      {
        "@type": "Question",
        name: "Is Kensington and Chelsea strict with extensions and loft conversions?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Kensington and Chelsea can be strict, especially in conservation areas and character streets. We shape each design to match local expectations and improve approval chances.",
        },
      },
      {
        "@type": "Question",
        name: "How long does Kensington and Chelsea Council take to decide?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
      ...
      {
        "@type": "Question",
        name: "Do you manage the full submission to Kensington and Chelsea Council?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Yes. We prepare drawings, complete forms, upload documents, submit to Kensington and Chelsea Council and respond to planning officer queries.",
        },
      },
    ],
  };
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings in Kensington and Chelsea | Extensions, Lofts, New Builds
        </title>
        <meta
          name="description"
          content="Architectural drawings in Kensington and Chelsea for house extensions, loft conversions, refurbishments, basements, new builds and building regulation packs. Fixed fees with clear scope and fast turnaround."
        />
        <link
          rel="canonical"
          href="https://www.wedrawplans.co.uk/areas/kensington-and-chelsea"
        />
        <script
      ...
      <div className="min-h-screen bg-[#f8f4f0] text-slate-900">
        <main>
            ...
            <div className="mx-auto max-w-5xl flex flex-col lg:flex-row gap-6 px-4 py-8 lg:px-6 lg:py-10">
              <div className="lg:w-1/2">
                ...
                <p className="mt-3 text-[13px] text-slate-700">
                  ...
                  loft conversions, refurbishments, basements, new builds and conversions
                  across the Royal Borough of Kensington and Chelsea. Fixed fees with clear
                  scope and fast communication.
                </p>

                <ul className="mt-4 space-y-1 text-[13px] text-slate-800">
                  <li>• House extensions, side returns and internal remodelling</li>
                  <li>• Loft conversions including rear dormers where suitable</li>
                  <li>• Refurbishments and reconfiguration for better layouts</li>
                  <li>• Planning drawings and building regulation packs</li>
                  <li>• Covering Kensington, Chelsea, Notting Hill, Holland Park and more</li>
              ...
              <div id="kensington-and-chelsea-quote" className="lg:w-1/2">
                <div className="bg-white p-5 rounded-2xl shadow-md">
                  ...
                  <p className="mt-1 text-[12px] text-slate-600">
                    Tell us a little about your property and what you plan to build. We will reply
                    with a clear fixed fee for your drawings.
                  </p>
                  ...
                  <form onSubmit={handleSubmit} className="mt-3 space-y-3 text-[13px]">
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onBlur={(e) => !e.target.value && (e.target.placeholder = "SW7 2AZ")}
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        name="projectDetails"
                        rows={4}
                        placeholder="For example: side return extension to a terrace in Notting Hill, with new kitchen and improved layout."
                    ...
                    <p className="text-[11px] text-slate-500 mt-2">
                      Typical projects include side return extensions, careful rear extensions, loft conversions,
                      refurbishments, and basement design and coordination where needed.
                    </p>
                  </form>
                </div>
              </div>
          ...
          <ServiceInternalLinks boroughName="Kensington and Chelsea" />
            ...
            <div className="mx-auto max-w-5xl px-4 lg:px-6 space-y-10">
              <div className="grid md:grid-cols-[1.7fr,1.3fr] gap-10 items-start">
                <div className="space-y-4">
                  ...
                  <p className="text-[13px] text-slate-700">
                    ...
                    refurbishments, internal alterations, flat layouts and small new developments
                    across Kensington and Chelsea.
                  </p>
                  <p className="text-[13px] text-slate-700">
                    We work throughout Kensington, Chelsea, Notting Hill, Holland Park, South Kensington,
                    North Kensington and nearby streets.
                  </p>
                ...
                <div className="rounded-2xl bg-white shadow-md border border-slate-100 overflow-hidden">
                  <Image
                    ...
                    alt="Example of architectural drawings for a Kensington and Chelsea project"
                    width={800}
                    height={500}
              ...
              <div className="grid md:grid-cols-2 gap-10">
                <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-[13px] text-slate-700">
                    ...
                    <ul className="list-disc pl-4 space-y-1">
                      ...
                      <li>Portobello</li>
                      <li>Knightsbridge borders</li>
                      <li>Kensington High Street area</li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-[13px] text-slate-700">
                    <ul className="list-disc pl-4 space-y-1">
                      <li>Side return and rear extensions</li>
                      <li>Internal reconfiguration for better layouts</li>
                      <li>Loft conversions where suitable</li>
                      <li>Lightwells and improved daylight</li>
                      <li>Front facade sensitive upgrades</li>
                    </ul>
                    <ul className="list-disc pl-4 space-y-1">
                      <li>Refurbishments and full fit out</li>
                      <li>Basement design coordination</li>
                      <li>Flats and layout changes</li>
                      <li>New build infill where suitable</li>
                      <li>Technical packs for Building Control</li>
                    </ul>
                  </div>
                  <Image
                    src="/images/hero.jpg"
              ...
              <div className="space-y-5">
                ...
                <p className="text-[13px] text-slate-700">
                  ...
                  house type, location, conservation area status and any Article 4 directions.
                </p>
              ...
              <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-6 space-y-3">
                ...
                <p className="text-[13px] text-emerald-900">
                  Kensington and Chelsea includes many conservation areas, listed buildings, and highly sensitive street
                  scenes. We shape each scheme to match local context, manage details carefully, and support a strong
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-6 text-[13px] text-slate-700">
                  <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                    ...
                    <p>
                      Many projects can proceed under permitted development, but local controls can be stricter. We
                  ...
                  <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                    <h3 className="font-semibold text-slate-900">Do you submit to the council</h3>
                    <p>
