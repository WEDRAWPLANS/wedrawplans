...
export default function CroydonAreaPage() {
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    alert(
      "Thank you. In the live site this form will email WEDRAWPLANS with your Croydon enquiry and trigger a same day call back."
    );
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings in Croydon – Extensions, Lofts and New Builds
        </title>
        <meta
          name="description"
          content="Architectural drawings in Croydon for house extensions, loft conversions, flat conversions, new builds and building regulation packs. Fixed fees from £750 with fast turnaround."
        />
      </Head>
      ...
      <div className="min-h-screen bg-[#f8f4f0] text-slate-900">
        ...
        <main>
            ...
            <div className="mx-auto flex max-w-5xl flex-col gap-6 px-4 py-8 lg:flex-row lg:items-start lg:px-6 lg:py-10">
              ...
              <div className="lg:w-1/2">
                ...
                <h1 className="mt-2 text-[22px] font-semibold uppercase leading-snug tracking-[0.14em] text-slate-900 sm:text-[26px]">
                  Plans for extensions, lofts and new builds in Croydon
                </h1>
              ...
              <div id="croydon-quote" className="lg:w-1/2">
                <div className="rounded-2xl bg-white p-5 shadow-md">
                  <h2 className="text-[14px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                    Free fixed quote for Croydon projects
                  </h2>
                  <p className="mt-1 text-[12px] text-slate-600">
                    Tell us a little about your property in Croydon and what you plan
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium text-slate-700">
                        Brief description of your Croydon project
                      </label>
                      <textarea
                        name="projectDetails"
                        rows={4}
                        placeholder="For example: rear extension and loft conversion to 1930s semi in Croydon with open plan kitchen and extra bedroom."
                    ...
                    <p className="mt-2 text-[11px] text-slate-500">
                      Typical Croydon projects include extensions and loft conversions
                      to 1930s semis and terraces, flat conversions and new build infill
          ...
          <section className="border-b border-slate-200 bg-white py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Common project types in Croydon
              </h2>
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                Croydon has a mix of Victorian terraces, 1930s semis, post-war
                housing and modern apartment blocks. Many owners extend, convert
                lofts, or reconfigure layouts to create better living space.
              </p>
              <div className="mt-5 grid gap-5 text-[13px] md:grid-cols-2">
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Rear kitchen and dining extensions, side infills and wraparound
                    schemes are common. We set out structure, glazing and layouts
                    carefully to maximise light and space.
                  </p>
                </div>
                <div>
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    ...
                    and bathrooms. We design efficient stair positions, good headroom
                ...
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Many larger houses are converted into self contained flats or
                    HMOs. We prepare layouts, stacking, access and amenity details in
                ...
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Side plots, garages and backland sites across Croydon can offer
                    development potential. We prepare plans, elevations and supporting
                    drawings suitable for planning.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="border-b border-slate-200 bg-[#f8f4f0] py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              ...
              <ul className="mt-4 grid gap-2 text-[13px] text-slate-800 md:grid-cols-2">
                ...
                <li>• Purley, Kenley and Coulsdon</li>
                <li>• Thornton Heath and Norbury</li>
                <li>• Addiscombe and Shirley</li>
                <li>• New Addington and Selsdon</li>
          ...
          <section className="border-b border-slate-200 bg-white py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Clear fixed fees for Croydon projects
              </h2>
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                Fees for Croydon projects follow the same clear structure as the
          ...
          <section className="bg-[#f8f4f0] py-10">
            <div className="mx-auto max-w-5xl px-4 text-center lg:px-6">
              <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Ready to move your Croydon project forward
              </h2>
              <p className="mt-3 text-[13px] text-slate-700">
                Share a few details and WEDRAWPLANS will reply with a clear fixed
                fee and suggested next steps for your Croydon extension, loft, new
