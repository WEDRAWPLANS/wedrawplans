...
export default function RedbridgeAreaPage() {
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    alert(
      "Thank you. In the live site this form will email WEDRAWPLANS with your Redbridge enquiry and trigger a same day call back."
    );
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings in Redbridge – Extensions, Lofts and New Builds
        </title>
        <meta
          name="description"
          content="Architectural drawings in Redbridge for house extensions, loft conversions, new builds and building regulation packs. Fixed fees from £750 with fast turnaround."
        />
      </Head>
      ...
      <div className="min-h-screen bg-[#f8f4f0] text-slate-900">
        ...
        <main>
            ...
            <div className="mx-auto flex max-w-5xl flex-col gap-6 px-4 py-8 lg:flex-row lg:items-start lg:px-6 lg:py-10">
              ...
              <div className="lg:w-1/2">
                ...
                <h1 className="mt-2 text-[22px] font-semibold uppercase leading-snug tracking-[0.14em] text-slate-900 sm:text-[26px]">
                  Plans for extensions, lofts and new builds in Redbridge
                </h1>
                <p className="mt-3 text-[13px] text-slate-700">
                  ...
                  the London Borough of Redbridge. Fixed fees with clear scope and
                  fast communication.
                </p>
                <ul className="mt-4 space-y-1 text-[13px] text-slate-800">
                  ...
                  <li>• Covering Ilford, Seven Kings, Gants Hill, Wanstead and more</li>
              ...
              <div id="redbridge-quote" className="lg:w-1/2">
                <div className="rounded-2xl bg-white p-5 shadow-md">
                  <h2 className="text-[14px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                    Free fixed quote for Redbridge projects
                  </h2>
                  <p className="mt-1 text-[12px] text-slate-600">
                    Tell us a little about your property in Redbridge and what you
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium text-slate-700">
                        Brief description of your Redbridge project
                      </label>
                      <textarea
                        name="projectDetails"
                        rows={4}
                        placeholder="For example: rear extension to terraced house in Ilford with new kitchen and larger dining space."
                    ...
                    <p className="mt-2 text-[11px] text-slate-500">
                      Typical Redbridge projects include extensions and loft
                      conversions to terraces and semi detached houses, as well as
          ...
          <section className="border-b border-slate-200 bg-white py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Common project types in Redbridge
              </h2>
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                Redbridge has a mix of terraces, semis and larger detached
                properties. Many owners extend, convert lofts or remodel internally
                instead of moving.
              </p>
              <div className="mt-5 grid gap-5 text-[13px] md:grid-cols-2">
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Kitchen and dining extensions to the rear, sometimes combined
                    with side infill to create larger open plan spaces. We set out
                ...
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Rear dormer lofts are very common in Redbridge. We design
                    efficient layouts with stairs, headroom and fire protection in
                    mind.
                  </p>
                </div>
                <div>
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Some backland and side plots in Redbridge have potential for a
                    new house or small residential scheme. We prepare layouts,
                    elevations and information suitable for planning.
                  </p>
                </div>
                <div>
                  <h3 className="text-[14px] font-semibold uppercase tracking-[0.14em] text-slate-900">
                  ...
                  <p className="mt-2 text-[13px] text-slate-700">
                    Larger properties near town centres can sometimes be converted
                    into self contained flats. We set out unit layouts, access and
                    amenity considerations and coordinate with planning advice.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="border-b border-slate-200 bg-[#f8f4f0] py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              ...
              <ul className="mt-4 grid gap-2 text-[13px] text-slate-800 md:grid-cols-2">
                <li>• Ilford and Seven Kings</li>
                <li>• Goodmayes and Chadwell Heath side of Redbridge</li>
                <li>• Gants Hill and Barkingside</li>
                <li>• Wanstead and South Woodford</li>
                <li>• Woodford Green and Clayhall</li>
          ...
          <section className="border-b border-slate-200 bg-white py-10">
            <div className="mx-auto max-w-5xl px-4 lg:px-6">
              <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Clear fixed fees for Redbridge projects
              </h2>
              <p className="mt-3 max-w-3xl text-[13px] text-slate-700">
                Fees for Redbridge projects follow the same clear structure as the
          ...
          <section className="bg-[#f8f4f0] py-10">
            <div className="mx-auto max-w-5xl px-4 text-center lg:px-6">
              <h2 className="text-[18px] font-semibold uppercase tracking-[0.16em] text-slate-900">
                Ready to move your Redbridge project forward
              </h2>
              <p className="mt-3 text-[13px] text-slate-700">
                Share a few details and WEDRAWPLANS will reply with a clear fixed
                fee and suggested next steps for your Redbridge extension, loft, new
