...
export default function Brent() {
  const localBusinessJson = {
    ...
    "@type": "LocalBusiness",
    name: "WEDRAWPLANS",
    url: "https://www.wedrawplans.co.uk/brent",
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings Brent | Extensions, Lofts, Conversions |
          WEDRAWPLANS
        </title>
        <meta
          name="description"
          content="Architectural drawing services in Brent for extensions, loft conversions, outbuildings, refurbishments and building regulation plans. Fast surveys, clear drawings and full planning support with Brent Council."
        />
        <link rel="canonical" href="https://www.wedrawplans.co.uk/brent" />
        <script
        ...
        <section className="relative bg-emerald-900 text-white">
          ...
          <div className="absolute inset-0 opacity-15 mix-blend-soft-light">
            <Image
              ...
              alt="Architectural drawings for Brent extensions and lofts"
              fill
          ...
          <div className="relative mx-auto max-w-5xl px-6 py-16 space-y-8">
            ...
            <p className="max-w-3xl text-sm md:text-base text-emerald-50">
              Architectural drawing services in Brent for house extensions, loft
              conversions, outbuildings, flat conversions and small new build
              homes. All drawings are prepared to Brent Council guidance and
            ...
            <div className="grid md:grid-cols-[2fr,1.2fr] gap-8 items-start">
              <div className="space-y-3 text-sm">
                <div className="grid sm:grid-cols-2 gap-3">
                  ...
                  <ul className="space-y-1 list-disc pl-4">
                    <li>Drawings tailored to Brent planning policies</li>
                ...
                <p className="mt-2 text-xs text-emerald-100">
                  Typical Brent projects include rear and wrap extensions in
                  Willesden and Dollis Hill, loft conversions and internal
                  reconfiguration in Neasden and Kingsbury, and full
                  refurbishments and conversions around Wembley and Harlesden.
                </p>
              </div>
        ...
        <section className="mx-auto max-w-5xl px-6 py-14 space-y-14">
          ...
          <div className="grid md:grid-cols-[1.7fr,1.3fr] gap-10 items-start">
            <div className="space-y-4">
              ...
              <p className="text-sm md:text-base text-slate-700">
                ...
                developments across the borough of Brent.
              </p>
              <p className="text-sm md:text-base text-slate-700">
                We work throughout Willesden, Willesden Green, Dollis Hill,
                Neasden, Harlesden, Stonebridge, Wembley, Wembley Park,
                Kingsbury, Queensbury, Cricklewood, Kilburn (Brent side) and
                Kenton.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-white shadow-md border border-slate-100 overflow-hidden">
              ...
              <div className="p-5 space-y-2">
                ...
                <p className="text-sm text-slate-700">
                  ...
                  coordinated with structural design so that Brent Council and
                  your builder can work from a single, accurate set of plans.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
              <h3 className="text-lg font-semibold">Brent areas we cover</h3>
              <Image
                src="/images/brent-area.jpg"
                alt="Brent local high street and residential area"
                width={800}
                height={500}
                className="rounded-xl object-cover mb-3"
              />
              <p className="text-sm text-slate-700">
                Architectural drawings for the whole borough of Brent,
                including:
              </p>
            ...
            <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
              <h3 className="text-lg font-semibold">Popular projects in Brent</h3>
          ...
          <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-6 space-y-3">
            ...
            <p className="text-sm text-emerald-900">
              Brent includes conservation areas, dense terraces, busy corridors
              around Wembley and a mix of post war housing and Victorian and
              Edwardian streets. We design each scheme to work with these local
              rules so that the approval process is as smooth as possible.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 text-sm text-slate-700">
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  Do I need planning permission for my Brent extension?
                </h3>
                <p>
              ...
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                ...
                <p>
                  ...
                  Brent within forty eight hours of instruction.
                </p>
              </div>
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  Do you submit the application to Brent Council?
                </h3>
                <p>
