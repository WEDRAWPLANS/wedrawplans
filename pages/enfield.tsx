...
export default function EnfieldAreaPage() {
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings in Enfield | Extensions, Lofts, New Builds
        </title>
        <meta
          name="description"
          ...
          <div className="mx-auto max-w-6xl px-4 pt-6 pb-3 lg:px-6">
            ...
            <div className="mt-2 flex w-full items-center justify-between gap-3">
              <div className="text-[12px] text-slate-700">
                <span className="font-semibold text-slate-900">Enfield</span>{" "}
                borough page
              </div>
            ...
            <div className="mx-auto max-w-5xl flex flex-col lg:flex-row gap-6 px-4 py-8 lg:px-6 lg:py-10">
              ...
              <div className="lg:w-1/2">
                ...
                <p className="mt-3 text-[13px] text-slate-700">
                  ...
                  extensions, loft conversions, outbuildings and refurbishments
                  across the London Borough of Enfield. Fixed fees with clear
                ...
                <ul className="mt-4 space-y-1 text-[13px] text-slate-800">
                  ...
                  <li>• Rear extensions, wrap arounds and side extensions</li>
                ...
                <div className="bg-white p-5 rounded-2xl shadow-md">
                  ...
                  >
                    ...
                    <p className="text-[11px] text-slate-500 mt-2">
                      Typical Enfield projects include 3 m and 6 m rear
                      extensions, wrap arounds, hip to gable lofts and garden
                      rooms.
                    </p>
                  </form>
                </div>
            ...
            <div className="mx-auto max-w-5xl px-4 lg:px-6 space-y-10">
              <div className="grid md:grid-cols-[1.7fr,1.3fr] gap-10 items-start">
                <div className="space-y-4">
                  ...
                  <p className="text-[13px] text-slate-700">
                    ...
                    extensions, double storey additions, loft conversions,
                    internal alterations, garage conversions, flat conversions
                    and small new developments across Enfield.
                  </p>
                  <p className="text-[13px] text-slate-700">
                    We work throughout Enfield Town, Southgate, Palmers Green,
                    Winchmore Hill, Grange Park, Oakwood, Bush Hill Park,
                    Edmonton, Ponders End, Enfield Highway, Enfield Lock,
                    Cockfosters and nearby areas.
                  </p>
                ...
                <div className="rounded-2xl bg-white shadow-md border border-slate-100 overflow-hidden">
                  ...
                  <div className="p-5 space-y-2">
                    ...
                    <p className="text-[13px] text-slate-700">
                      Detailed plans, elevations, sections and notes coordinated
                      with structural design so Enfield Council, Building
                      Control and your builder can work from a single accurate
                      set of information.
                    </p>
                  </div>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-10">
                <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
                  ...
                  />
                  <p className="text-[13px] text-slate-700">
                    We provide architectural drawings across the whole borough
                    of Enfield, including:
                  </p>
              ...
              <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-6 space-y-3">
                ...
                <p className="text-[13px] text-emerald-900">
                  Enfield includes conservation areas, character streets and
                  corner plots with specific design guidance. We design each
                  scheme to work with local rules and improve the chances of a
                ...
                <div className="grid md:grid-cols-2 gap-6 text-[13px] text-slate-700">
                  ...
                  <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                    ...
                    <p>
                      ...
                      in Enfield within forty eight hours of instruction.
                    </p>
                  </div>
                  <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                    <h3 className="font-semibold text-slate-900">
                    ...
                    <p>
                      Yes. We handle the full submission process, monitor
                      progress and respond to planning officer comments or
                      requests.
                    </p>
                  </div>
                  <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                    ...
                    <p>
                      We coordinate with structural engineers so beams and load
                      bearing elements are fully designed and shown on the
                      drawings.
                    </p>
                  </div>
                </div>
