...
export default function Camden() {
  const localBusinessJson = {
    ...
    "@type": "LocalBusiness",
    name: "WEDRAWPLANS",
    url: "https://www.wedrawplans.co.uk/camden",
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings Camden | Extensions, Lofts, Conversions |
          WEDRAWPLANS
        </title>
        <meta
          name="description"
          content="Architectural drawing services in Camden for extensions, loft conversions, flat conversions, outbuildings and building regulation plans. Fast surveys, clear drawings and full planning support with Camden Council."
        />
        <link rel="canonical" href="https://www.wedrawplans.co.uk/camden" />
        <script
