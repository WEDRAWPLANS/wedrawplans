...
export default function Harrow() {
  const localBusinessJson = {
    ...
    "@type": "LocalBusiness",
    name: "WEDRAWPLANS",
    url: "https://www.wedrawplans.co.uk/harrow",
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Yes. We prepare all drawings, complete the forms, upload documents, submit to Harrow Council and respond to planning officer queries."
        }
      }
    ]
  };
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings Harrow | Extensions, Lofts, Conversions |
          WEDRAWPLANS
        </title>
        <meta
          name="description"
          content="Architectural drawing services in Harrow for extensions, loft conversions, outbuildings, refurbishments and building regulation plans. Fast surveys, clear drawings and full planning support with Harrow Council."
        />
        ...
        <section className="relative bg-emerald-900 text-white">
          ...
          <div className="relative mx-auto max-w-5xl px-6 py-16 space-y-8">
            ...
            <p className="max-w-3xl text-sm md:text-base text-emerald-50">
              Architectural drawing services in Harrow for house extensions, loft
              conversions, outbuildings, flat conversions and small new build
              homes. All drawings are prepared to Harrow Council guidance and
            ...
            <div className="grid md:grid-cols-[2fr,1.2fr] gap-8 items-start">
              <div className="space-y-3 text-sm">
                <div className="grid sm:grid-cols-2 gap-3">
                  ...
                  <ul className="space-y-1 list-disc pl-4">
                    <li>Drawings tailored to Harrow planning policies</li>
                ...
                <p className="mt-2 text-xs text-emerald-100">
                  Typical Harrow projects include large rear extensions in Harrow
                  Weald and Rayners Lane, loft conversions on semis in Kenton and
                  North Harrow, and full refurbishments and conversions around
                  Harrow on the Hill and Wealdstone.
                </p>
              </div>
        ...
        <section className="mx-auto max-w-5xl px-6 py-14 space-y-14">
          ...
          <div className="grid md:grid-cols-[1.7fr,1.3fr] gap-10 items-start">
            <div className="space-y-4">
              ...
              <p className="text-sm md:text-base text-slate-700">
                ...
                developments across the borough of Harrow.
              </p>
              <p className="text-sm md:text-base text-slate-700">
                We work throughout Harrow on the Hill, Harrow Weald, North Harrow,
                South Harrow, West Harrow, Wealdstone, Rayners Lane, Kenton,
                Pinner borders, Queensbury side, Stanmore borders and surrounding
                streets.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-white shadow-md border border-slate-100 overflow-hidden">
              ...
              <div className="p-5 space-y-2">
                ...
                <p className="text-sm text-slate-700">
                  ...
                  with structural design so that Harrow Council and your builder
                  can work from a single, accurate set of plans.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
              <h3 className="text-lg font-semibold">Harrow areas we cover</h3>
              <Image
                src="/images/harrow-area.jpg"
                alt="Harrow local high street and residential area"
                width={800}
                height={500}
                className="rounded-xl object-cover mb-3"
              />
              <p className="text-sm text-slate-700">
                Architectural drawings for the whole borough of Harrow, including:
              </p>
            ...
            <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
              <h3 className="text-lg font-semibold">Popular projects in Harrow</h3>
          ...
          <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-6 space-y-3">
            ...
            <p className="text-sm text-emerald-900">
              Harrow includes conservation areas at Harrow on the Hill, character
              streets with strong design guidance and a mix of suburban semis and
              terraces. We design each scheme to work with these local rules so
            ...
            <div className="grid md:grid-cols-2 gap-6 text-sm text-slate-700">
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  Do I need planning permission for my Harrow extension?
                </h3>
                <p>
                  Many extensions and lofts can proceed under permitted
                  development. We check your address, house type and location and
                  then advise the best route at the start.
                </p>
              </div>
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                ...
                <p>
                  ...
                  Harrow within forty eight hours of instruction.
                </p>
              </div>
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  Do you submit the application to Harrow Council?
                </h3>
                <p>
                  Yes. We handle the full submission process, monitor progress on
                  the planning portal and respond to any planning officer comments
                  or requests.
                </p>
              </div>
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                ...
                <p>
                  ...
                  padstones and load bearing elements are fully designed and
