...
export default function Redbridge() {
  const localBusinessJson = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "WEDRAWPLANS",
    url: "https://www.wedrawplans.co.uk/redbridge",
    ...
    description:
      "Architectural drawing services in Redbridge for extensions, loft conversions, outbuildings, refurbishments and building regulations."
  };
  ...
  const faqJson = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Do I need planning permission for a rear extension in Redbridge?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Not always. Many rear extensions in Redbridge can be carried out under permitted development. We confirm the correct route once we review your address and house type."
        }
      },
      {
        "@type": "Question",
        name: "Is Redbridge strict with loft conversions and extensions?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Redbridge follows national permitted development rules but can be stricter near conservation areas, along key routes and where extensions affect neighbour amenity."
        }
      },
      {
        "@type": "Question",
        name: "How long does Redbridge Council take to decide?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
      ...
      {
        "@type": "Question",
        name: "Do you manage the full application to Redbridge Council?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Yes. We prepare all drawings, complete the forms, upload documents, submit to Redbridge Council and respond to planning officer queries."
        }
      }
    ]
  };
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings Redbridge | Extensions, Lofts, Conversions |
          WEDRAWPLANS
        </title>
        <meta
          name="description"
          content="Architectural drawing services in Redbridge for extensions, loft conversions, outbuildings, refurbishments and building regulation plans. Fast surveys, clear drawings and full planning support with Redbridge Council."
        />
        <link rel="canonical" href="https://www.wedrawplans.co.uk/redbridge" />
        <script
        ...
        <section className="relative bg-emerald-900 text-white">
          ...
          <div className="absolute inset-0 opacity-15 mix-blend-soft-light">
            <Image
              ...
              alt="Architectural drawings for Redbridge extensions and lofts"
              fill
          ...
          <div className="relative mx-auto max-w-5xl px-6 py-16 space-y-8">
            <p className="text-xs font-semibold tracking-[0.2em] text-emerald-100">
              WEDRAWPLANS • REDBRIDGE
            </p>

            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
              Architectural Drawings in Redbridge
            </h1>

            <p className="max-w-3xl text-sm md:text-base text-emerald-50">
              Architectural drawing services in Redbridge for house extensions,
              loft conversions, outbuildings, flat conversions and small new
              build homes. All drawings are prepared to Redbridge Council
            ...
            <div className="grid md:grid-cols-[2fr,1.2fr] gap-8 items-start">
              <div className="space-y-3 text-sm">
                <div className="grid sm:grid-cols-2 gap-3">
                  ...
                  <ul className="space-y-1 list-disc pl-4">
                    <li>Drawings tailored to Redbridge planning policies</li>
                ...
                <p className="mt-2 text-xs text-emerald-100">
                  Typical Redbridge projects include large rear extensions in
                  Clayhall and Barkingside, loft conversions in Seven Kings and
                  Goodmayes, and full refurbishments and conversions in Ilford
                  and Wanstead.
                </p>
              </div>
        ...
        <section className="mx-auto max-w-5xl px-6 py-14 space-y-14">
          ...
          <div className="grid md:grid-cols-[1.7fr,1.3fr] gap-10 items-start">
            <div className="space-y-4">
              ...
              <p className="text-sm md:text-base text-slate-700">
                ...
                developments across the borough of Redbridge.
              </p>
              <p className="text-sm md:text-base text-slate-700">
                We work throughout Ilford, Gants Hill, Clayhall, Barkingside,
                Seven Kings, Goodmayes, Chadwell Heath, Wanstead, Newbury Park,
                Hainault, South Woodford and Woodford Bridge.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-white shadow-md border border-slate-100 overflow-hidden">
              <Image
                src="/images/drawings.jpg"
                alt="Example of architectural drawings for a Redbridge extension"
                width={800}
                height={500}
              ...
              <div className="p-5 space-y-2">
                ...
                <p className="text-sm text-slate-700">
                  ...
                  coordinated with structural design so that Redbridge Council
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
              <h3 className="text-lg font-semibold">Redbridge areas we cover</h3>
              <Image
                src="/images/redbridge-area.jpg"
                alt="Redbridge local high street and residential area"
                width={800}
                height={500}
                className="rounded-xl object-cover mb-3"
              />
              <p className="text-sm text-slate-700">
                Architectural drawings for the whole borough of Redbridge,
                including:
              </p>
              <div className="grid grid-cols-2 gap-2 text-sm text-slate-700">
                ...
                <ul className="list-disc pl-4 space-y-1">
                  ...
                  <li>Woodford Bridge</li>
                </ul>
              </div>
            </div>

            <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
              <h3 className="text-lg font-semibold">Popular projects in Redbridge</h3>
          ...
          <div className="space-y-5">
            <h2 className="text-2xl font-semibold">
              Permitted development limits in Redbridge
            </h2>
            <p className="text-sm text-slate-700">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="rounded-2xl bg-white shadow-sm p-6 border border-slate-100 space-y-4">
              <h3 className="text-lg font-semibold">
                Planning drawings for Redbridge
              </h3>
            ...
            <div className="rounded-2xl bg-white shadow-sm p-6 border border-slate-100 space-y-4">
              <h3 className="text-lg font-semibold">
                Building regulation drawings for Redbridge
              </h3>
              <ul className="list-disc pl-4 space-y-1 text-sm text-slate-700">
          ...
          <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-6 space-y-3">
            <h2 className="text-2xl font-semibold text-emerald-900">
              Local planning knowledge for Redbridge projects
            </h2>
            <p className="text-sm text-emerald-900">
              Redbridge includes conservation areas at Wanstead, areas with
              deeper gardens in Clayhall and Barkingside, and busy corridors
              around Ilford and Eastern Avenue. We design each scheme to work
              with these local rules so that the approval process is as smooth
              as possible.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 text-sm text-slate-700">
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  Do I need planning permission for my Redbridge extension?
                </h3>
                <p>
              ...
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                ...
                <p>
                  ...
                  Redbridge within forty eight hours of instruction.
                </p>
              </div>
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  Do you submit the application to Redbridge Council?
                </h3>
                <p>
          ...
          <div className="rounded-2xl bg-slate-900 text-white p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h2 className="text-xl font-semibold">
                Ready to start your Redbridge project
              </h2>
