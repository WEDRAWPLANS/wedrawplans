...
export default function Southwark() {
  const localBusinessJson = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "WEDRAWPLANS",
    url: "https://www.wedrawplans.co.uk/southwark",
    ...
    description:
      "Architectural drawing services in Southwark for extensions, loft conversions, flat conversions, outbuildings and building regulation plans."
  };
  ...
  const faqJson = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Do I need planning permission for a rear extension in Southwark?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Not always. Many rear extensions in Southwark can be carried out under permitted development. We confirm the correct route once we review your address and house type."
        }
      },
      {
        "@type": "Question",
        name: "Is Southwark strict with loft conversions and extensions?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Southwark can be strict in conservation areas and on streets with strong character, especially around Camberwell, Dulwich and parts of Bermondsey. Careful drawings and planning arguments help a lot."
        }
      },
      {
        "@type": "Question",
        name: "How long does Southwark Council take to decide?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
      ...
      {
        "@type": "Question",
        name: "Do you manage the full application to Southwark Council?",
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Yes. We prepare drawings, complete forms, upload documents, submit to Southwark Council and respond to planning officer queries."
        }
      }
    ]
  };
  ...
  return (
    <>
      <Head>
        <title>
          Architectural Drawings Southwark | Extensions, Lofts, Conversions | WEDRAWPLANS
        </title>
        <meta
          name="description"
          content="Architectural drawing services in Southwark for extensions, loft conversions, flat conversions, outbuildings and building regulation plans. Fast surveys, clear drawings and full planning support with Southwark Council."
        />
        <link rel="canonical" href="https://www.wedrawplans.co.uk/southwark" />
        <script
        ...
        <section className="relative bg-emerald-900 text-white">
          <div className="absolute inset-0 opacity-15 mix-blend-soft-light">
            <Image
              ...
              alt="Architectural drawings for Southwark extensions and lofts"
              fill
          ...
          <div className="relative mx-auto max-w-5xl px-6 py-16 space-y-8">
            ...
            <p className="max-w-3xl text-sm md:text-base text-emerald-50">
              Architectural drawing services in Southwark for house extensions, loft
              conversions, flat conversions, outbuildings and small new build homes.
              All drawings are prepared to Southwark Council guidance and current
              ...
              <div className="space-y-3 text-sm">
                <div className="grid sm:grid-cols-2 gap-3">
                  <ul className="space-y-1 list-disc pl-4">
                    ...
                    <li>Support with flats and maisonettes</li>
                  </ul>
                  <ul className="space-y-1 list-disc pl-4">
                    <li>Drawings tailored to Southwark policies</li>
                ...
                <p className="mt-2 text-xs text-emerald-100">
                  Typical Southwark projects include rear and side extensions in
                  Camberwell and Peckham, loft conversions in Nunhead and East Dulwich,
                  and flat conversions and refurbishments around Borough, Elephant and
                  Castle and Surrey Quays.
                </p>
              </div>
        ...
        <section className="mx-auto max-w-5xl px-6 py-14 space-y-14">
          ...
          <div className="grid md:grid-cols-[1.7fr,1.3fr] gap-10 items-start">
            <div className="space-y-4">
              ...
              <p className="text-sm md:text-base text-slate-700">
                ...
                outbuildings across the London Borough of Southwark.
              </p>
              <p className="text-sm md:text-base text-slate-700">
                We work throughout Camberwell, Peckham, Dulwich, East Dulwich, Nunhead,
                Borough, Elephant and Castle, Walworth, Bermondsey, Surrey Quays and
                Rotherhithe.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-white shadow-md border border-slate-100 overflow-hidden">
              <Image
                src="/images/drawings.jpg"
                alt="Example of architectural drawings for a Southwark project"
                width={800}
                height={500}
              ...
              <div className="p-5 space-y-2">
                <h3 className="text-lg font-semibold">
                  Clear drawings for South East and Central London homes
                </h3>
                <p className="text-sm text-slate-700">
                  Detailed plans, elevations and sections that respond to typical
                  Southwark housing stock including Victorian terraces, 1930s homes,
                  post war infill and modern apartments.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
              <h3 className="text-lg font-semibold">Southwark areas we cover</h3>
              <Image
                src="/images/southwark-area.jpg"
                alt="Southwark local high street and residential area"
                width={800}
                height={500}
                className="rounded-xl object-cover mb-3"
              />
              <p className="text-sm text-slate-700">
                Architectural drawings for the whole borough of Southwark, including:
              </p>
              <div className="grid grid-cols-2 gap-2 text-sm text-slate-700">
                <ul className="list-disc pl-4 space-y-1">
                  <li>Camberwell and Denmark Hill</li>
                  <li>Peckham and Nunhead</li>
                  <li>East Dulwich and Dulwich</li>
                  <li>Borough and London Bridge fringe</li>
                  <li>Elephant and Castle</li>
                  <li>Walworth</li>
                </ul>
                <ul className="list-disc pl-4 space-y-1">
                  <li>Bermondsey and Old Kent Road</li>
                  <li>Surrey Quays and Canada Water</li>
                  <li>Rotherhithe</li>
                  <li>Local estates and streets</li>
                  <li>Backland and corner plots</li>
                  <li>Mixed use and small commercial</li>
                </ul>
              </div>
            </div>

            <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-6 space-y-4">
              <h3 className="text-lg font-semibold">Popular projects in Southwark</h3>
          ...
          <div className="space-y-5">
            <h2 className="text-2xl font-semibold">
              Planning and permitted development in Southwark
            </h2>
            <p className="text-sm text-slate-700">
              Many houses in Southwark benefit from permitted development rights but
              flats and maisonettes require full planning permission. Conservation
              areas and Article 4 directions can limit automatic rights and need
              careful design.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 text-sm text-slate-700">
              <div>
                ...
                <ul className="list-disc pl-4 space-y-1">
                  <li>Typical PD depths of around 3 to 4 metres</li>
                  <li>Deeper schemes may need Prior Approval</li>
                  <li>Height and massing tested against neighbours</li>
              ...
              <div>
                ...
                <ul className="list-disc pl-4 space-y-1">
                  ...
                  <li>Dormer shapes often guided by local character</li>
                  <li>Terraces and roof terraces need strong planning case</li>
                </ul>
              </div>
              <div>
                ...
                <ul className="list-disc pl-4 space-y-1">
                  ...
                  <li>We design to London Plan and local standards</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="rounded-2xl bg-white shadow-sm p-6 border border-slate-100 space-y-4">
              <h3 className="text-lg font-semibold">
                Planning drawings for Southwark
              </h3>
            ...
            <div className="rounded-2xl bg-white shadow-sm p-6 border border-slate-100 space-y-4">
              <h3 className="text-lg font-semibold">
                Building regulation drawings for Southwark
              </h3>
              <ul className="list-disc pl-4 space-y-1 text-sm text-slate-700">
          ...
          <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-6 space-y-3">
            ...
            <p className="text-sm text-emerald-900">
              Southwark contains conservation areas, dense terraces, larger family
              homes and mixed use streets. We design schemes that respect local
              character while giving you the extra space, light and storage that you
              need, with a strong planning case for approval.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 text-sm text-slate-700">
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  Can you help with flat conversions in Southwark?
                </h3>
                <p>
                  Yes. We regularly work on flat conversions and reorganising existing
                  units in Southwark, ensuring layouts meet space, access and amenity
                  standards.
                </p>
              </div>
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  How fast can you survey a property in Southwark?
                </h3>
                <p>
              ...
              <div className="space-y-2 rounded-xl bg-white border border-slate-100 p-4">
                <h3 className="font-semibold">
                  Do you handle the planning submission to Southwark Council?
                </h3>
                <p>
          ...
          <div className="rounded-2xl bg-slate-900 text-white p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h2 className="text-xl font-semibold">
                Ready to start your Southwark project
              </h2>
